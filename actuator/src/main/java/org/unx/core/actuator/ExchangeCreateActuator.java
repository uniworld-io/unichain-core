...
public class ExchangeCreateActuator extends AbstractActuator {
  ...
  public boolean execute(Object object) throws ContractExeException {
    ...
    try {
      ...
      if (Arrays.equals(firstTokenID, UNW_SYMBOL_BYTES)) {
      ...
      if (Arrays.equals(secondTokenID, UNW_SYMBOL_BYTES)) {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (!accountStore.has(ownerAddress)) {
      throw new ContractValidateException("account[" + readableOwnerAddress + ActuatorConstant.NOT_EXIST_STR);
    }
    ...
    if (dynamicStore.getAllowSameTokenName() == 1) {
      if (!Arrays.equals(firstTokenID, UNW_SYMBOL_BYTES) && !isNumber(firstTokenID)) {
        throw new ContractValidateException("first token id is not a valid number");
      }
      if (!Arrays.equals(secondTokenID, UNW_SYMBOL_BYTES) && !isNumber(secondTokenID)) {
