...
import static org.unx.core.capsule.utils.TransactionUtil.isNumber;
...
import org.unx.protos.Protocol.MarketOrder.State;
import org.unx.protos.Protocol.MarketOrderDetail;
...
public class MarketSellAssetActuator extends AbstractActuator {
  ...
  private void matchSingleOrder(MarketOrderCapsule takerOrderCapsule,
    ...
    // for makerPrice,sellToken is A,buyToken is UNW.
    // for takerPrice,buyToken is A,sellToken is UNW.

    // makerSellTokenQuantity_A/makerBuyTokenQuantity_UNW =
    //   takerBuyTokenQuantityCurrent_A/takerSellTokenQuantityRemain_UNW
    // => takerBuyTokenQuantityCurrent_A = takerSellTokenQuantityRemain_UNW *
    //   makerSellTokenQuantity_A/makerBuyTokenQuantity_UNW
    ...
    if (takerBuyTokenQuantityRemain == makerOrderCapsule.getSellTokenQuantityRemain()) {
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_UNW =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_UNW
      // => makerBuyTokenQuantityCurrent_UNW = makerSellTokenQuantityRemain_A *
      //   makerBuyTokenQuantity_UNW / makerSellTokenQuantity_A
      ...
      // makerSellTokenQuantityRemain_A/makerBuyTokenQuantityCurrent_UNX =
      //   makerSellTokenQuantity_A/makerBuyTokenQuantity_UNX
      makerBuyTokenQuantityReceive = MarketUtils
          .multiplyAndDivide(makerSellRemainQuantity, makerBuyQuantity, makerSellQuantity);
    ...
    addUnxOrToken(takerOrderCapsule, takerBuyTokenQuantityReceive, takerAccountCapsule);
    addUnxOrToken(makerOrderCapsule, makerBuyTokenQuantityReceive);
  ...
  // for taker
  private void addUnxOrToken(MarketOrderCapsule orderCapsule, long num,
