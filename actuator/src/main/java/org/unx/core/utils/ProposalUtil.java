...
public class ProposalUtil {
  ...
  public static void validator(DynamicPropertiesStore dynamicPropertiesStore,
    ...
    switch (proposalType) {
      ...
      case ALLOW_UVM_TRANSFER_URC10: {
        if (value != 1) {
          throw new ContractValidateException(
              PRE_VALUE_NOT_ONE_ERROR + "ALLOW_UVM_TRANSFER_URC10" + VALUE_NOT_ONE_ERROR);
        }
        if (dynamicPropertiesStore.getAllowSameTokenName() == 0) {
          throw new ContractValidateException("[ALLOW_SAME_TOKEN_NAME] proposal must be approved "
              + "before [ALLOW_UVM_TRANSFER_URC10] can be proposed");
        }
        break;
      }
      ...
      case ALLOW_UVM_CONSTANTINOPLE: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_3_6)) {
          throw new ContractValidateException(BAD_PARAM_ID);
        }
        if (value != 1) {
          throw new ContractValidateException(
              PRE_VALUE_NOT_ONE_ERROR + "ALLOW_UVM_CONSTANTINOPLE" + VALUE_NOT_ONE_ERROR);
        }
        if (dynamicPropertiesStore.getAllowUvmTransferUrc10() == 0) {
          throw new ContractValidateException(
              "[ALLOW_UVM_TRANSFER_URC10] proposal must be approved "
                  + "before [ALLOW_UVM_CONSTANTINOPLE] can be proposed");
        }
        break;
      }
      case ALLOW_UVM_SOLIDITY_059: {
        ...
        if (value != 1) {
          throw new ContractValidateException(
              PRE_VALUE_NOT_ONE_ERROR + "ALLOW_UVM_SOLIDITY_059" + VALUE_NOT_ONE_ERROR);
        }
        if (dynamicPropertiesStore.getAllowCreationOfContracts() == 0) {
          throw new ContractValidateException(
              "[ALLOW_CREATION_OF_CONTRACTS] proposal must be approved "
                  + "before [ALLOW_UVM_SOLIDITY_059] can be proposed");
        }
        break;
      }
...
//      }
      ...
      case ALLOW_UVM_ISTANBUL: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_1)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_UVM_ISTANBUL]");
        }
        if (value != 1) {
          throw new ContractValidateException(
              "This value[ALLOW_UVM_ISTANBUL] is only allowed to be 1");
        }
        break;
      }
      case ALLOW_SHIELDED_URC20_TRANSACTION: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_0_1)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_SHIELDED_URC20_TRANSACTION]");
        }
        if (value != 1 && value != 0) {
          throw new ContractValidateException(
              "This value[ALLOW_SHIELDED_URC20_TRANSACTION] is only allowed to be 1 or 0");
        }
        break;
      }
      ...
      case MAX_FEE_LIMIT: {
        ...
        if (value < 0) {
          ...
          if (dynamicPropertiesStore.getAllowUvmLondon() == 0) {
            throw new ContractValidateException(
      ...
      case ALLOW_UVM_FREEZE: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_2)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_UVM_FREEZE]");
        }
        if (value != 1) {
          throw new ContractValidateException(
              PRE_VALUE_NOT_ONE_ERROR + "ALLOW_UVM_FREEZE" + VALUE_NOT_ONE_ERROR);
        }
        if (dynamicPropertiesStore.getAllowDelegateResource() == 0) {
          throw new ContractValidateException(
              "[ALLOW_DELEGATE_RESOURCE] proposal must be approved "
                  + "before [ALLOW_UVM_FREEZE] can be proposed");
        }
        ...
        if (dynamicPropertiesStore.getAllowUvmConstantinople() == 0) {
          throw new ContractValidateException(
              "[ALLOW_UVM_CONSTANTINOPLE] proposal must be approved "
                  + "before [ALLOW_UVM_FREEZE] can be proposed");
        }
        if (dynamicPropertiesStore.getAllowUvmSolidity059() == 0) {
          throw new ContractValidateException(
              "[ALLOW_UVM_SOLIDITY_059] proposal must be approved "
                  + "before [ALLOW_UVM_FREEZE] can be proposed");
        }
        break;
      }
      case ALLOW_UVM_VOTE: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_3)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_UVM_VOTE]");
        }
        if (value != 1) {
          throw new ContractValidateException(
              PRE_VALUE_NOT_ONE_ERROR + "ALLOW_UVM_VOTE" + VALUE_NOT_ONE_ERROR);
        }
        if (dynamicPropertiesStore.getChangeDelegation() == 0) {
          throw new ContractValidateException(
              "[ALLOW_CHANGE_DELEGATION] proposal must be approved "
                  + "before [ALLOW_UVM_VOTE] can be proposed");
        }
        break;
      }
      case FREE_NET_LIMIT: {
      ...
      case ALLOW_UVM_LONDON: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_4)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_UVM_LONDON]");
        }
        if (value != 1) {
          throw new ContractValidateException(
              "This value[ALLOW_UVM_LONDON] is only allowed to be 1");
        }
        break;
      }
      case ALLOW_UVM_COMPATIBLE_EVM: {
        if (!forkController.pass(ForkBlockVersionEnum.VERSION_4_4)) {
          throw new ContractValidateException(
              "Bad chain parameter id [ALLOW_UVM_COMPATIBLE_EVM]");
        }
        if (value != 1) {
          throw new ContractValidateException(
              "This value[ALLOW_UVM_COMPATIBLE_EVM] is only allowed to be 1");
        }
        break;
      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 UNW, [0, 100000000000] UNW
    CREATE_ACCOUNT_FEE(2), // 0.1 UNW, [0, 100000000000] UNW
    TRANSACTION_FEE(3), // 10 Ginza/Byte, [0, 100000000000] UNW
    ASSET_ISSUE_FEE(4), // 1024 UNW, [0, 100000000000] UNW
    WITNESS_PAY_PER_BLOCK(5), // 16 UNW, [0, 100000000000] UNW
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 UNW, [0, 100000000000] UNW
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 UNW, [0, 100000000000] UNW
    ...
    ENERGY_FEE(11), // 10 Ginza, [0, 100000000000] UNW
    EXCHANGE_CREATE_FEE(12), // 1024 UNW, [0, 100000000000] UNW
