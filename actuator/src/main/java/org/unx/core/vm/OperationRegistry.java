...
public class OperationRegistry {
  ...
  static {
    tableMap.put(Version.UNX_V1_0, newUnxV10OperationSet());
    tableMap.put(Version.UNX_V1_1, newUnxV11OperationSet());
  }

  public static JumpTable newUnxV10OperationSet() {
    JumpTable table = newBaseOperationSet();
    appendTransferUrc10Operations(table);
  ...
  public static JumpTable newUnxV11OperationSet() {
    JumpTable table = newUnxV10OperationSet();
  ...
  public static JumpTable getTable() {
    ...
    if (VMConfig.allowHigherLimitForMaxCpuTimeOfOneTx()) {
      return tableMap.get(Version.UNX_V1_1);
    }
    return tableMap.get(Version.UNX_V1_0);
  }
  ...
  public static void appendTransferUrc10Operations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmTransferUrc10;
  ...
  public static void appendConstantinopleOperations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmConstantinople;
  ...
  public static void appendSolidity059Operations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmSolidity059;
  ...
  public static void appendIstanbulOperations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmIstanbul;
  ...
  public static void appendFreezeOperations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmFreeze;
  ...
  public static void appendVoteOperations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmVote;
  ...
  public static void appendLondonOperations(JumpTable table) {
    BooleanSupplier proposal = VMConfig::allowUvmLondon;
