package org.unx.core.vm.repository;
...
import org.unx.protos.Protocol.DelegatedResource;
import org.unx.protos.Protocol.Votes;
...
public class RepositoryImpl implements Repository {
  ...
  private Storage getStorageInternal(byte[] address) {
    address = TransactionTrace.convertToUnxAddress(address);
  ...
  public Storage getStorage(byte[] address) {
    ...
    if (contract != null) {
      ...
      if (!ByteUtil.isNullOrZeroArray(contract.getUnxHash())) {
