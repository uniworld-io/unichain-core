...
import org.unx.core.db.accountstate.AccountStateCallBackUtils;
import org.unx.protos.contract.BalanceContract.TransactionBalanceTrace;
import org.unx.protos.contract.BalanceContract.TransactionBalanceTrace.Operation;
...
@Component
public class AccountStore extends UnxStoreWithRevoking<AccountCapsule> {
