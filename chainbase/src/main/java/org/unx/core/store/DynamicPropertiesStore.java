...
@Slf4j(topic = "DB")
@Component
public class DynamicPropertiesStore extends UnxStoreWithRevoking<BytesCapsule> {
  ...
  //This value is only allowed to be 0, 1, -1
  private static final byte[] ALLOW_UVM_TRANSFER_URC10 = "ALLOW_UVM_TRANSFER_URC10".getBytes();
  ...
  private static final byte[] ALLOW_SHIELDED_URC20_TRANSACTION =
      "ALLOW_SHIELDED_URC20_TRANSACTION"
          .getBytes();
  private static final byte[] ALLOW_UVM_ISTANBUL = "ALLOW_UVM_ISTANBUL".getBytes();
  private static final byte[] ALLOW_UVM_CONSTANTINOPLE = "ALLOW_UVM_CONSTANTINOPLE".getBytes();
  private static final byte[] ALLOW_UVM_SOLIDITY_059 = "ALLOW_UVM_SOLIDITY_059".getBytes();
  ...
  private static final byte[] BURN_UNW_AMOUNT = "BURN_UNW_AMOUNT".getBytes();
  ...
  private static final byte[] ALLOW_UVM_FREEZE = "ALLOW_UVM_FREEZE".getBytes();
  private static final byte[] ALLOW_UVM_VOTE = "ALLOW_UVM_VOTE".getBytes();
  private static final byte[] ALLOW_UVM_LONDON = "ALLOW_UVM_LONDON".getBytes();
  private static final byte[] ALLOW_UVM_COMPATIBLE_EVM = "ALLOW_UVM_COMPATIBLE_EVM".getBytes();
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      this.getTotalUnxPowerWeight();
    } catch (IllegalArgumentException e) {
      this.saveTotalUnxPowerWeight(0L);
    }
    ...
    try {
      ...
      this.saveEnergyFee(DEFAULT_ENERGY_FEE); // 100 ginza per energy
    }
    ...
    try {
      ...
      this.saveCreateAccountFee(100_000L); // 0.1UNW
    }
    ...
    try {
      ...
      this.saveTransactionFee(10L); // 10ginza/byte
    }
    ...
    try {
      this.getAllowUvmTransferUrc10();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmTransferUrc10(CommonParameter.getInstance()
          .getAllowUvmTransferUrc10());
    }

    try {
      this.getAllowUvmConstantinople();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmConstantinople(CommonParameter.getInstance()
          .getAllowUvmConstantinople());
    }

    try {
      this.getAllowUvmSolidity059();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmSolidity059(CommonParameter.getInstance()
          .getAllowUvmSolidity059());
    }
    ...
    try {
      this.getAllowShieldedURC20Transaction();
    } catch (IllegalArgumentException e) {
      this.saveAllowShieldedURC20Transaction(
          CommonParameter.getInstance().getAllowShieldedURC20Transaction());
    }

    try {
      this.getAllowUvmIstanbul();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmIstanbul(
          CommonParameter.getInstance().getAllowUvmIstanbul());
    }
    ...
    try {
      this.getAllowUvmFreeze();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmFreeze(CommonParameter.getInstance().getAllowUvmFreeze());
    }

    try {
      this.getAllowUvmVote();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmVote(CommonParameter.getInstance().getAllowUvmVote());
      if (CommonParameter.getInstance().getAllowUvmVote() == 1) {
    ...
    try {
      this.getAllowUvmLondon();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmLondon(CommonParameter.getInstance().getAllowUvmLondon());
    }

    try {
      this.getAllowUvmCompatibleEvm();
    } catch (IllegalArgumentException e) {
      this.saveAllowUvmCompatibleEvm(CommonParameter.getInstance().getAllowUvmCompatibleEvm());
    }
  ...
  public void saveTotalUnxPowerWeight(long totalEnergyWeight) {
    this.put(DynamicResourceProperties.TOTAL_UNX_POWER_WEIGHT,
        new BytesCapsule(ByteArray.fromLong(totalEnergyWeight)));
  }

  public long getTotalUnxPowerWeight() {
    return Optional.ofNullable(getUnchecked(DynamicResourceProperties.TOTAL_UNX_POWER_WEIGHT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found TOTAL_UNX_POWER_WEIGHT"));
  }
  ...
  public void saveAllowUvmTransferUrc10(long value) {
    this.put(ALLOW_UVM_TRANSFER_URC10,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowUvmTransferUrc10() {
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_TRANSFER_URC10))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_UVM_TRANSFER_URC10"));
  }

  public void saveAllowUvmConstantinople(long value) {
    this.put(ALLOW_UVM_CONSTANTINOPLE,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowUvmConstantinople() {
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_CONSTANTINOPLE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_UVM_CONSTANTINOPLE"));
  }

  public void saveAllowUvmSolidity059(long value) {
    this.put(ALLOW_UVM_SOLIDITY_059,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowUvmSolidity059() {
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_SOLIDITY_059))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(() -> new IllegalArgumentException("not found ALLOW_UVM_SOLIDITY_059"));
  }
  ...
  public void updateDynamicStoreByConfig() {
    if (CommonParameter.getInstance()
        .getAllowUvmConstantinople() != 0) {
      saveAllowUvmConstantinople(CommonParameter.getInstance()
          .getAllowUvmConstantinople());
  ...
  public void saveAllowShieldedURC20Transaction(long allowShieldedURC20Transaction) {
    this.put(DynamicPropertiesStore.ALLOW_SHIELDED_URC20_TRANSACTION,
        new BytesCapsule(ByteArray.fromLong(allowShieldedURC20Transaction)));
  }

  public long getAllowShieldedURC20Transaction() {
    String msg = "not found ALLOW_SHIELDED_URC20_TRANSACTION";
    return Optional.ofNullable(getUnchecked(ALLOW_SHIELDED_URC20_TRANSACTION))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public void saveAllowUvmIstanbul(long allowUVMIstanbul) {
    this.put(DynamicPropertiesStore.ALLOW_UVM_ISTANBUL,
        new BytesCapsule(ByteArray.fromLong(allowUVMIstanbul)));
  }

  public long getAllowUvmIstanbul() {
    String msg = "not found ALLOW_UVM_ISTANBUL";
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_ISTANBUL))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public boolean supportShieldedURC20Transaction() {
    return getAllowShieldedURC20Transaction() == 1L;
  }
  ...
  //The unit is unx
  public void addTotalUnxPowerWeight(long amount) {
    long totalWeight = getTotalUnxPowerWeight();
    totalWeight += amount;
    saveTotalUnxPowerWeight(totalWeight);
  }
  ...
  public long getBurnUnwAmount() {
    return Optional.ofNullable(getUnchecked(BURN_UNW_AMOUNT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(() -> new IllegalArgumentException("not found BURN_UNW_AMOUNT"));
  }

  public void burnUnw(long amount) {
    if (amount <= 0) {
      return;
    }
    amount += getBurnUnwAmount();
    saveBurnUnw(amount);
  }

  private void saveBurnUnw(long amount) {
    this.put(BURN_UNW_AMOUNT, new BytesCapsule(ByteArray.fromLong(amount)));
  }
  ...
  public void saveAllowUvmFreeze(long allowUvmFreeze) {
    this.put(DynamicPropertiesStore.ALLOW_UVM_FREEZE,
        new BytesCapsule(ByteArray.fromLong(allowUvmFreeze)));
  }

  public long getAllowUvmFreeze() {
    String msg = "not found ALLOW_UVM_FREEZE";
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_FREEZE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public void saveAllowUvmVote(long allowUvmVote) {
    this.put(DynamicPropertiesStore.ALLOW_UVM_VOTE,
        new BytesCapsule(ByteArray.fromLong(allowUvmVote)));
  }

  public long getAllowUvmVote() {
    String msg = "not found ALLOW_UVM_VOTE";
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_VOTE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public void saveAllowUvmLondon(long allowUvmLondon) {
    this.put(DynamicPropertiesStore.ALLOW_UVM_LONDON,
        new BytesCapsule(ByteArray.fromLong(allowUvmLondon)));
  }

  public long getAllowUvmLondon() {
    String msg = "not found ALLOW_UVM_LONDON";
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_LONDON))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public void saveAllowUvmCompatibleEvm(long allowUvmCompatibleEvm) {
    this.put(DynamicPropertiesStore.ALLOW_UVM_COMPATIBLE_EVM,
        new BytesCapsule(ByteArray.fromLong(allowUvmCompatibleEvm)));
  }

  public long getAllowUvmCompatibleEvm() {
    String msg = "not found ALLOW_UVM_COMPATIBLE_EVM";
    return Optional.ofNullable(getUnchecked(ALLOW_UVM_COMPATIBLE_EVM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  private static class DynamicResourceProperties {
    ...
    private static final byte[] TOTAL_UNX_POWER_WEIGHT = "TOTAL_UNX_POWER_WEIGHT".getBytes();
