...
class MetricsCounter {
  ...
  static {
    init(MetricKeys.Counter.TXS, "unx  txs  info .", "type", "detail");
    init(MetricKeys.Counter.MINER, "unx  miner info .", "miner", "type");
    init(MetricKeys.Counter.BLOCK_FORK, "unx  block fork info .", "type");
    init(MetricKeys.Counter.P2P_ERROR, "unx p2p error  info .", "type");
    init(MetricKeys.Counter.P2P_DISCONNECT, "unx p2p disconnect .", "type");
