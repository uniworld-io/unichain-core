...
public class Constant {
  ...
  public static final long GINZA_PER_ENERGY = 100; // 1 us = 100 GINZA = 100 * 10^-6 UNW
  ...
  public static final byte[] ZUNW_EXPANDSEED_PERSONALIZATION = {'Z', 'u', 'n', 'w', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_UNX_PER_SECOND = "node.netMaxUnxPerSecond";
  ...
  public static final String COMMITTEE_ALLOW_UVM_TRANSFER_URC10 = "committee.allowUvmTransferUrc10";

  public static final String COMMITTEE_ALLOW_UVM_CONSTANTINOPLE = "committee.allowUvmConstantinople";

  public static final String COMMITTEE_ALLOW_UVM_SOLIDITY059 = "committee.allowUvmSolidity059";
  ...
  public static final String UNX_REFERENCE_BLOCK = "unx.reference.block";

  public static final String UNX_EXPIRATION_TIME_IN_MILLIS_SECONDS = "unx.expiration.timeInMilliseconds";

  public static final String NODE_RPC_MIN_EFFECTIVE_CONNECTION = "node.rpc.minEffectiveConnection";

  public static final String NODE_RPC_UNX_CACHE_ENABLE = "node.rpc.unxCacheEnable";
  ...
  public static final String COMMITTEE_ALLOW_SHIELDED_URC20_TRANSACTION = "committee"
      + ".allowShieldedURC20Transaction";

  public static final String COMMITTEE_ALLOW_UVM_ISTANBUL = "committee"
      + ".allowUvmIstanbul";
  ...
  public static final String COMMITTEE_ALLOW_UVM_FREEZE = "committee.allowUvmFreeze";
  public static final String COMMITTEE_ALLOW_UVM_VOTE = "committee.allowUvmVote";

  public static final String COMMITTEE_ALLOW_UVM_LONDON = "committee.allowUvmLondon";
  public static final String COMMITTEE_ALLOW_UVM_COMPATIBLE_EVM = "committee.allowUvmCompatibleEvm";
