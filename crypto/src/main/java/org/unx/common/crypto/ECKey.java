...
import org.unx.common.crypto.jce.ECKeyPairGenerator;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(UnxCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = UnxCastleProvider.getInstance();
  }
   ...
   * as the PKCS11 Provider will return a generic PrivateKey instance
