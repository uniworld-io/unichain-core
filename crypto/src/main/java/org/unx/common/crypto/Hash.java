...
import static org.unx.common.utils.ByteUtil.isNullOrZeroArray;
import static org.unx.common.utils.ByteUtil.isSingleZero;
...
public class Hash {
  ...
  static {
    Security.addProvider(UnxCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("BC");
    HASH_256_ALGORITHM_NAME = "UNX-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "UNX-KECCAK-512";
