package org.unx.common.crypto.sm2;

import static org.unx.common.crypto.Hash.computeAddress;
import static org.unx.common.utils.BIUtil.isLessThan;
import static org.unx.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.unx.common.crypto.jce.ECKeyFactory;
import org.unx.common.crypto.jce.UnxCastleProvider;
...
public class SM2 implements Serializable, SignInterface {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(UnxCastleProvider.getInstance())
