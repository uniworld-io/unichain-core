package org.unx.common.overlay.client;
...
import org.unx.common.overlay.server.UnxChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "UnxJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    UnxChannelInitializer unxChannelInitializer = ctx
        .getBean(UnxChannelInitializer.class, remoteId);
    unxChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(unxChannelInitializer);
