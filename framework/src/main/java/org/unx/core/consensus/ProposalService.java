...
import org.unx.core.utils.ProposalUtil;
    ...
    for (Map.Entry<Long, Long> entry : map.entrySet()) {
      ...
      switch (proposalType) {
        ...
        case ALLOW_UVM_TRANSFER_URC10: {
          manager.getDynamicPropertiesStore().saveAllowUvmTransferUrc10(entry.getValue());
          break;
        }
        ...
        case ALLOW_UVM_CONSTANTINOPLE: {
          manager.getDynamicPropertiesStore().saveAllowUvmConstantinople(entry.getValue());
        ...
        case ALLOW_UVM_ISTANBUL: {
          manager.getDynamicPropertiesStore().saveAllowUvmIstanbul(entry.getValue());
          break;
        }
        case ALLOW_SHIELDED_URC20_TRANSACTION: {
          manager.getDynamicPropertiesStore().saveAllowShieldedURC20Transaction(entry.getValue());
          break;
        }
        ...
        case ALLOW_UVM_FREEZE: {
          manager.getDynamicPropertiesStore().saveAllowUvmFreeze(entry.getValue());
          break;
        }
        case ALLOW_UVM_VOTE: {
          manager.getDynamicPropertiesStore().saveAllowUvmVote(entry.getValue());
          manager.getDynamicPropertiesStore().saveNewRewardAlgorithmEffectiveCycle();
          break;
        }
        case ALLOW_UVM_LONDON: {
          manager.getDynamicPropertiesStore().saveAllowUvmLondon(entry.getValue());
          break;
        }
        case ALLOW_UVM_COMPATIBLE_EVM: {
          manager.getDynamicPropertiesStore().saveAllowUvmCompatibleEvm(entry.getValue());
          break;
        }
        case FREE_NET_LIMIT: {
