...
import static org.unx.protos.Protocol.Transaction.Contract.ContractType.ShieldedTransferContract;
import static org.unx.protos.Protocol.Transaction.Contract.ContractType.TransferAssetContract;
...
public class BandwidthProcessor extends ResourceProcessor {
  ...
  public long calculateGlobalNetLimit(AccountCapsule accountCapsule) {
    ...
    long netWeight = frozeBalance / UNW_PRECISION;
