...
import org.unx.common.entity.NodeInfo.ConfigNodeInfo;
import org.unx.common.entity.NodeInfo.MachineInfo;
import org.unx.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.unx.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.unx.common.entity.PeerInfo;
...
import org.unx.common.prometheus.MetricTime;
import org.unx.core.ChainBaseManager;
import org.unx.core.db.Manager;
import org.unx.core.net.peer.PeerConnection;
import org.unx.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getLastRemoteDisconnectReason();
