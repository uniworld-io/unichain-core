...
import org.unx.api.GrpcAPI.EasyTransferAssetByPrivateMessage;
import org.unx.api.GrpcAPI.EasyTransferAssetMessage;
import org.unx.api.GrpcAPI.EasyTransferByPrivateMessage;
...
import org.unx.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.unx.api.GrpcAPI.TransactionIdList;
import org.unx.api.GrpcAPI.TransactionInfoList;
import org.unx.api.GrpcAPI.TransactionList;
import org.unx.api.GrpcAPI.TransactionListExtention;
import org.unx.api.GrpcAPI.TransactionSignWeight;
import org.unx.api.GrpcAPI.ViewingKeyMessage;
import org.unx.api.GrpcAPI.WitnessList;
import org.unx.api.MonitorGrpc;
import org.unx.api.WalletExtensionGrpc;
import org.unx.api.WalletGrpc.WalletImplBase;
...
import org.unx.core.metrics.MetricsApiService;
...
import org.unx.protos.Protocol.NodeInfo;
...
import org.unx.protos.Protocol.TransactionSign;
import org.unx.protos.contract.AccountContract.AccountCreateContract;
import org.unx.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.unx.protos.contract.AccountContract.AccountUpdateContract;
import org.unx.protos.contract.AccountContract.SetAccountIdContract;
import org.unx.protos.contract.AssetIssueContractOuterClass.AssetIssueContract;
import org.unx.protos.contract.AssetIssueContractOuterClass.ParticipateAssetIssueContract;
import org.unx.protos.contract.AssetIssueContractOuterClass.TransferAssetContract;
import org.unx.protos.contract.AssetIssueContractOuterClass.UnfreezeAssetContract;
import org.unx.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.unx.protos.contract.BalanceContract.AccountBalanceRequest;
import org.unx.protos.contract.BalanceContract.AccountBalanceResponse;
...
import org.unx.protos.contract.BalanceContract.UnfreezeBalanceContract;
import org.unx.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.unx.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.unx.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.unx.protos.contract.ExchangeContract.ExchangeTransactionContract;
import org.unx.protos.contract.ExchangeContract.ExchangeWithdrawContract;
import org.unx.protos.contract.MarketContract.MarketCancelOrderContract;
import org.unx.protos.contract.MarketContract.MarketSellAssetContract;
import org.unx.protos.contract.ProposalContract.ProposalApproveContract;
import org.unx.protos.contract.ProposalContract.ProposalCreateContract;
import org.unx.protos.contract.ProposalContract.ProposalDeleteContract;
...
import org.unx.protos.contract.SmartContractOuterClass.ClearABIContract;
...
import org.unx.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
...
import org.unx.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class RpcApiService implements Service {
  ...
  private TransactionExtention transaction2Extention(Transaction transaction) {
    ...
    unxExtBuilder.setTxid(Sha256Hash.of(CommonParameter.getInstance()
  ...
  private void checkSupportShieldedURC20Transaction() throws ZksnarkException {
    String msg = "Not support Shielded URC20 Transaction, need to be opened by the committee";
    if (!dbManager.getDynamicPropertiesStore().supportShieldedURC20Transaction()) {
      throw new ZksnarkException(msg);
    }
  }
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.unx.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.unx.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getBurnUnw(EmptyMessage request, StreamObserver<NumberMessage> responseObserver) {
      getBurnUnwCommon(request, responseObserver);
    }
    ...
    public void scanShieldedURC20NotesByIvk(IvkDecryptURC20Parameters request,
      ...
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      byte[] contractAddress = request.getShieldedURC20ContractAddress().toByteArray();
      ...
      try {
        checkSupportShieldedURC20Transaction();
        responseObserver.onNext(
            wallet.scanShieldedURC20NotesByIvk(startNum, endNum, contractAddress, ivk, ak, nk,
                topicsList));
    ...
    public void scanShieldedURC20NotesByOvk(OvkDecryptURC20Parameters request,
      ...
      try {
        ...
        responseObserver
            .onNext(wallet
                .scanShieldedURC20NotesByOvk(startNum, endNum, ovk, contractAddress, topicList));
      } catch (Exception e) {
        responseObserver.onError(getRunTimeException(e));
      }
      responseObserver.onCompleted();
    ...
    public void isShieldedURC20ContractNoteSpent(NfURC20Parameters request,
      ...
      try {
        checkSupportShieldedURC20Transaction();
        responseObserver.onNext(wallet.isShieldedURC20ContractNoteSpent(request));
      } catch (Exception e) {
        responseObserver.onError(getRunTimeException(e));
      }
      responseObserver.onCompleted();
  ...
  public class WalletApi extends WalletImplBase {
    ...
    public void getTransactionSign2(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule unx = TransactionUtil.getTransactionSign(req);
        unxExtBuilder.setTransaction(unx.getInstance());
        unxExtBuilder.setTxid(unx.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    public void addSign(TransactionSign req,
      ...
      Return.Builder retBuilder = Return.newBuilder();
      try {
        TransactionCapsule unx = transactionUtil.addSign(req);
        unxExtBuilder.setTransaction(unx.getInstance());
        unxExtBuilder.setTxid(unx.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (Exception e) {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      if (dbManager.getDynamicPropertiesStore().supportAllowNewResourceModel()) {
        Preconditions.checkArgument(account.getAllUnwPower() < votesCount,
            "unx power[" + account.getAllUnwPower() + "] <  VotesCount[" + votesCount + "]");
      } else {
        Preconditions.checkArgument(account.getUnwPower() < votesCount,
            "unx power[" + account.getUnwPower() + "] <  VotesCount[" + votesCount + "]");
      }
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.unx.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void createShieldedTransaction(PrivateParameters request,
      ...
      try {
        ...
        TransactionCapsule unx = wallet.createShieldedTransaction(request);
        unxExtBuilder.setTransaction(unx.getInstance());
        unxExtBuilder.setTxid(unx.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
    ...
    public void createShieldedTransactionWithoutSpendAuthSig(PrivateParametersWithoutAsk request,
      ...
      try {
        ...
        TransactionCapsule unx = wallet.createShieldedTransactionWithoutSpendAuthSig(request);
        unxExtBuilder.setTransaction(unx.getInstance());
        unxExtBuilder.setTxid(unx.getTransactionId().getByteString());
        retBuilder.setResult(true).setCode(response_code.SUCCESS);
      } catch (ContractValidateException | ZksnarkException e) {
    ...
    public void createShieldedContractParameters(
        ...
        StreamObserver<org.unx.api.GrpcAPI.ShieldedURC20Parameters> responseObserver) {
      try {
        checkSupportShieldedURC20Transaction();

        ShieldedURC20Parameters shieldedURC20Parameters = wallet
            .createShieldedContractParameters(request);
        responseObserver.onNext(shieldedURC20Parameters);
      } catch (Exception e) {
        responseObserver.onError(getRunTimeException(e));
    ...
    @Override
    public void scanShieldedURC20NotesByIvk(
        IvkDecryptURC20Parameters request,
        StreamObserver<org.unx.api.GrpcAPI.DecryptNotesURC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        checkSupportShieldedURC20Transaction();

        DecryptNotesURC20 decryptNotes = wallet.scanShieldedURC20NotesByIvk(startNum, endNum,
        ...
        responseObserver.onError(getRunTimeException(e));
        logger.info("scanShieldedURC20NotesByIvk exception caught: " + e.getMessage());
        return;
      }
      responseObserver.onCompleted();
    }
    ...
    @Override
    public void scanShieldedURC20NotesByOvk(
        OvkDecryptURC20Parameters request,
        StreamObserver<org.unx.api.GrpcAPI.DecryptNotesURC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        ...
        DecryptNotesURC20 decryptNotes = wallet.scanShieldedURC20NotesByOvk(startNum, endNum,
        ...
        responseObserver.onError(getRunTimeException(e));
        logger.info("scanShieldedURC20NotesByOvk exception caught: " + e.getMessage());
        return;
      }
      responseObserver.onCompleted();
    }
    ...
    public void isShieldedURC20ContractNoteSpent(NfURC20Parameters request,
      ...
      try {
        ...
        GrpcAPI.NullifierResult nf = wallet
            .isShieldedURC20ContractNoteSpent(request);
        responseObserver.onNext(nf);
      } catch (Exception e) {
        responseObserver.onError(getRunTimeException(e));
        return;
    ...
    @Override
    public void getTriggerInputForShieldedURC20Contract(
        ShieldedURC20TriggerContractParameters request,
        io.grpc.stub.StreamObserver<org.unx.api.GrpcAPI.BytesMessage> responseObserver) {
      try {
        checkSupportShieldedURC20Transaction();

        responseObserver.onNext(wallet.getTriggerInputForShieldedURC20Contract(request));
      } catch (Exception e) {
        responseObserver.onError(e);
        return;
      }
  ...
  public void getBurnUnwCommon(EmptyMessage request,
      StreamObserver<NumberMessage> responseObserver) {
    try {
      long value = dbManager.getDynamicPropertiesStore().getBurnUnwAmount();
      NumberMessage.Builder builder = NumberMessage.newBuilder();
      builder.setNum(value);
      responseObserver.onNext(builder.build());
    } catch (Exception e) {
