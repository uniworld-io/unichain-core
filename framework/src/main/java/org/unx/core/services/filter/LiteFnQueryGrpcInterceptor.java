...
public class LiteFnQueryGrpcInterceptor implements ServerInterceptor {
  ...
  static {
    ...
    filterMethods.add("protocol.Wallet/ScanShieldedURC20NotesByIvk");
    filterMethods.add("protocol.Wallet/ScanShieldedURC20NotesByOvk");
    filterMethods.add("protocol.Wallet/IsShieldedURC20ContractNoteSpent");
    ...
    filterMethods.add("protocol.WalletSolidity/ScanShieldedURC20NotesByIvk");
    filterMethods.add("protocol.WalletSolidity/ScanShieldedURC20NotesByOvk");
    filterMethods.add("protocol.WalletSolidity/IsShieldedURC20ContractNoteSpent");
