...
public class LiteFnQueryHttpFilter implements Filter {
  ...
  static {
    ...
    filterPaths.add("/wallet/scanshieldedurc20notesbyivk");
    filterPaths.add("/wallet/scanshieldedurc20notesbyovk");
    filterPaths.add("/wallet/isshieldedurc20contractnotespent");
    ...
    filterPaths.add("/walletsolidity/scanshieldedurc20notesbyivk");
    filterPaths.add("/walletsolidity/scanshieldedurc20notesbyovk");
    filterPaths.add("/walletsolidity/isshieldedurc20contractnotespent");
    ...
    filterPaths.add("/walletpbft/scanshieldedurc20notesbyivk");
    filterPaths.add("/walletpbft/scanshieldedurc20notesbyovk");
    filterPaths.add("/walletpbft/isshieldedurc20contractnotespent");
  }
