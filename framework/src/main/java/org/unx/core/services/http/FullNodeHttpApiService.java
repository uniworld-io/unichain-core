...
import org.unx.core.services.filter.HttpInterceptor;
...
public class FullNodeHttpApiService implements Service {
  ...
  @Autowired
  private GetTriggerInputForShieldedURC20ContractServlet
      getTriggerInputForShieldedURC20ContractServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context
          .addServlet(new ServletHolder(isShieldedURC20ContractNoteSpentServlet),
              "/wallet/isshieldedurc20contractnotespent");
      ...
      context.addServlet(new ServletHolder(scanShieldedURC20NotesByIvkServlet),
          "/wallet/scanshieldedurc20notesbyivk");
      context.addServlet(new ServletHolder(scanShieldedURC20NotesByOvkServlet),
          "/wallet/scanshieldedurc20notesbyovk");
      context.addServlet(new ServletHolder(getTriggerInputForShieldedURC20ContractServlet),
      ...
      context.addServlet(new ServletHolder(getBurnUnwServlet), "/wallet/getburnunw");
