...
public class HttpSelfFormatFieldName {
  ...
  static {
    ...
    //PrivateShieldedURC20Parameters
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedURC20Parameters.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedURC20Parameters.shielded_URC20_contract_address", 1);
    //PrivateShieldedURC20ParametersWithoutAsk
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedURC20ParametersWithoutAsk.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.PrivateShieldedURC20ParametersWithoutAsk.shielded_URC20_contract_address", 1);
    //IvkDecryptURC20Parameters
    AddressFieldNameMap.put(
        "protocol.IvkDecryptURC20Parameters.shielded_URC20_contract_address", 1);
    //OvkDecryptURC20Parameters
    AddressFieldNameMap.put(
        "protocol.OvkDecryptURC20Parameters.shielded_URC20_contract_address", 1);
    //NfURC20Parameters
    AddressFieldNameMap.put(
        "protocol.NfURC20Parameters.shielded_URC20_contract_address", 1);
    //ShieldedURC20TriggerContractParameters
    AddressFieldNameMap.put(
        "protocol.ShieldedURC20TriggerContractParameters.transparent_to_address", 1);
    AddressFieldNameMap.put(
        "protocol.DecryptNotesURC20.NoteTx.transparent_to_address", 1);
