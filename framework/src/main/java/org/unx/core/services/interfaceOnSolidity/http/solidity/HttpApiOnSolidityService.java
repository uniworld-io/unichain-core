...
import org.unx.core.services.interfaceOnSolidity.http.GetAccountByIdOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetAccountOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetAssetIssueByIdOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetAssetIssueByNameOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetAssetIssueListByNameOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetAssetIssueListOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBlockByIdOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBlockByLatestNumOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBlockByLimitNextOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBlockByNumOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBrokerageOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetBurnUnwOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetDelegatedResourceAccountIndexOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetDelegatedResourceOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetEnergyPricesOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetExchangeByIdOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMarketOrderByAccountOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMarketOrderByIdOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMarketOrderListByPairOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMarketPairListOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMarketPriceByPairOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetMerkleTreeVoucherInfoOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetNodeInfoOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetNowBlockOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetPaginatedAssetIssueListOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetRewardOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetTransactionCountByBlockNumOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.GetTransactionInfoByBlockNumOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.IsShieldedURC20ContractNoteSpentOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.IsSpendOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ListExchangesOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ListWitnessesOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ScanAndMarkNoteByIvkOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ScanNoteByIvkOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ScanNoteByOvkOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ScanShieldedURC20NotesByIvkOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.ScanShieldedURC20NotesByOvkOnSolidityServlet;
import org.unx.core.services.interfaceOnSolidity.http.TriggerConstantContractOnSolidityServlet;
...
public class HttpApiOnSolidityService implements Service {
  ...
  @Autowired
  private ScanShieldedURC20NotesByIvkOnSolidityServlet scanShieldedURC20NotesByIvkOnSolidityServlet;
  @Autowired
  private ScanShieldedURC20NotesByOvkOnSolidityServlet scanShieldedURC20NotesByOvkOnSolidityServlet;
  @Autowired
  private IsShieldedURC20ContractNoteSpentOnSolidityServlet
      isShieldedURC20ContractNoteSpentOnSolidityServlet;
  @Autowired
  private GetBrokerageOnSolidityServlet getBrokerageServlet;
  @Autowired
  private GetRewardOnSolidityServlet getRewardServlet;
  @Autowired
  private GetBurnUnwOnSolidityServlet getBurnUnwOnSolidityServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(scanShieldedURC20NotesByIvkOnSolidityServlet),
          "/walletsolidity/scanshieldedurc20notesbyivk");
      context.addServlet(new ServletHolder(scanShieldedURC20NotesByOvkOnSolidityServlet),
          "/walletsolidity/scanshieldedurc20notesbyovk");
      context.addServlet(new ServletHolder(isShieldedURC20ContractNoteSpentOnSolidityServlet),
      ...
      context
          .addServlet(new ServletHolder(getBurnUnwOnSolidityServlet), "/walletsolidity/getburnunw");
