package org.unx.core.trie;

import static org.apache.commons.lang3.concurrent.ConcurrentUtils.constantFuture;
import static org.unx.common.crypto.Hash.EMPTY_TRIE_HASH;
import static org.unx.common.utils.ByteArray.toHexString;
import static org.unx.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.unx.core.capsule.utils.RLP.encodeList;
...
import org.unx.core.capsule.utils.FastByteComparisons;
import org.unx.core.capsule.utils.RLP;
import org.unx.core.db2.common.ConcurrentHashDB;
    ...
    private byte[] encode(final int depth, boolean forceHash) {
      if (!dirty) {
        ...
        if (type == NodeType.BranchNode) {
          ...
          ret = RLP.encodeList(Hash.encodeElement(kvNodeGetKey().toPacked()),
