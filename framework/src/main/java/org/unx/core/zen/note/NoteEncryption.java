...
import static org.unx.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.unx.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.unx.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.unx.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.unx.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.unx.common.zksnark.JLibsodiumParam.Chacha20Poly1305IetfEncryptParams;
import org.unx.common.zksnark.JLibsodiumParam.Chacha20poly1305IetfDecryptParams;
import org.unx.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.unx.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
import org.unx.core.exception.ZksnarkException;
import org.unx.core.utils.ZenChainParams;
import org.unx.core.zen.address.DiversifierT;
import org.unx.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.unx.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.unx.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.unx.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
public class NoteEncryption {
  ...
  public static class Encryption {
    ...
    public static void prfOck(byte[] ock, byte[] ovk, byte[] cv, byte[] cm, byte[] epk)
      ...
      byte[] temp = "Zunw_Derive_ock".getBytes();
    ...
    public static void kdfSapling(byte[] kEnc, byte[] sharedsecret, byte[] epk)
      ...
      byte[] personalization = new byte[JLibsodium.CRYPTO_GENERICHASH_BLAKE2B_PERSONALBYTES];
      byte[] temp = "Zunw_SaplingKDF".getBytes();
      System.arraycopy(temp, 0, personalization, 0, temp.length);
      if (JLibsodium.cryptoGenerichashBlack2bSaltPersonal(new Black2bSaltPersonalParams(
