...
import org.unx.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new UnxApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    UnxNetService unxNetService = context.getBean(UnxNetService.class);
    unxNetService.stop();
