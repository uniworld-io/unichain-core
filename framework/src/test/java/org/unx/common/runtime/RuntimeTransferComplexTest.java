...
public class RuntimeTransferComplexTest {
   ...
   */
  @Test
  public void TransferUnxToContractAccountWhenDeployAContract()
    ...
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(unx, repository, null);
  ...
  @Test
  public void TransferUnxToContractAccountFailIfNotPayable()
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
   ...
   */
  @Test
  public void TransferUnxToContractAccountWhenTriggerAContract()
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    ...
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction, repository, null);
    Assert.assertNull(runtime.getRuntimeError());
  ...
  public void TransferCallValueTestWhenUsingCallAndCreate()
    ...
    String params1 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData1 = UvmTestUtils.parseAbi(selectorStr1, params1);

    Transaction transaction1 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData1, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction1, repository, null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(calledAddress).getBalance(),
        1000 - 5);  //Transfer 5 ginza to TransferTo
    Assert.assertEquals(dbManager.getAccountStore().get(Hex.decode(TRANSFER_TO)).getBalance(),
        transferToInitBalance + 5); // get 5 ginza from calledAddress
    recoverDeposit();
    ...
    String params2 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData2 = UvmTestUtils.parseAbi(selectorStr2, params2);

    Transaction transaction2 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData2, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction2, repository, null);
    ...
    String params3 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData3 = UvmTestUtils.parseAbi(selectorStr3, params3);

    Transaction transaction3 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData3, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction3, repository, null);
    ...
    String params4 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData4 = UvmTestUtils.parseAbi(selectorStr4, params4);

    Transaction transaction4 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData4, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction4, repository, null);
    byte[] createdAddress = convertToUnxAddress(
    ...
    String params5 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData5 = UvmTestUtils.parseAbi(selectorStr5, params5);

    Transaction transaction5 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData5, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction5, repository, null);
    byte[] createdAddress2 = convertToUnxAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    ...
    String params6 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData6 = UvmTestUtils.parseAbi(selectorStr6, params6);

    Transaction transaction6 = UvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData6, triggerCallValue, feeLimit);
    runtime = UvmTestUtils.processTransactionAndReturnRuntime(transaction6, repository, null);
    byte[] createdAddress3 = convertToUnxAddress(
        new DataWord(runtime.getResult().getHReturn()).getLast20Bytes());
    Assert.assertTrue(Hex.toHexString(new DataWord(createdAddress2).getLast20Bytes())
        .equalsIgnoreCase("0000000000000000000000000000000000000000"));
    Assert.assertTrue(runtime.getRuntimeError().contains("Invalid operation code: opCode[fe];"));
