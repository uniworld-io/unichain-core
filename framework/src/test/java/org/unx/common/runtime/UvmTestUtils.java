...
public class UvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction unx = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(unx, repository, block);
    return WalletUtil.generateContractAddress(unx);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
    ...
    return processTransactionAndReturnRuntime(unx, repository, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule unxCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = unxCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = unxCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction unx = transactionBuilder.build();
    return unx;
  }
  ...
  /**
   * use given input Transaction,repository,block and execute UVM  (for both Deploy and Trigger
   * contracts).
   */

  public static Runtime processTransactionAndReturnRuntime(Transaction unx,
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction unx,
  ...
  public static UVMTestResult deployContractAndReturnUvmTestResult(String contractName,
                                                                   byte[] callerAddress,
                                                                   String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
    ...
    return processTransactionAndReturnUvmTestResult(unx, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(unx));
  }

  public static UVMTestResult deployContractWithCreatorEnergyLimitAndReturnUvmTestResult(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction unx = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(
  ...
  public static UVMTestResult triggerContractAndReturnUvmTestResult(byte[] callerAddress,
  ...
  public static UVMTestResult processTransactionAndReturnUvmTestResult(Transaction unx,
    ...
    trace.setResult();
    return new UVMTestResult(trace.getRuntime(), trace.getReceipt(), null);
  }
