...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String unx2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      unxCap.setResultCode(contractResult.OUT_OF_ENERGY);
      ...
      Assert.assertEquals(9950000 * Constant.GINZA_PER_ENERGY,
