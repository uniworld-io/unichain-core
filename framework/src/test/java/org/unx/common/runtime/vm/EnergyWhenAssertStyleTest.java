...
public class EnergyWhenAssertStyleTest {
  ...
  public void outOfIndexTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testOutOfIndex()", null);
    result = UvmTestUtils
  ...
  public void bytesNTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testbytesN()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void divZeroTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testDivZero()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void shiftByNegativeTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testShiftByNegative()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void enumTypeTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testEnumType()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void functionPointerTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testFunctionPointer()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void assertTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testAssert()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void systemPrecompileTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("voteForSingleWitness(address,uint256)", params);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void outOfMemTest()
    ...
    byte[] triggerData = UvmTestUtils.parseAbi("testMem(uint256)", params);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
