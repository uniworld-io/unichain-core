...
public class EnergyWhenRequireStyleTest {
  ...
  public void throwTest()
    ...
    UVMTestResult result = UvmTestUtils
        .deployContractAndReturnUvmTestResult(contractName, address, ABI, code, value, feeLimit,
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testThrow()", null);
    result = UvmTestUtils
  ...
  public void requireTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testRequire()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thisFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testThisFunctionViaMessageCall()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thatFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testThatFunctionViaMessageCall()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void newContractTest1()
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testNewContract()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  // }
  //
  // contract testReceiveUnwWithoutPayableContract {
  //
  //   constructor() {}
  //
  ...
  @Test
  public void receiveUnwWithoutPayableTest()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException,
      VMIllegalException {
    ...
    result = UvmTestUtils
        .deployContractAndReturnUvmTestResult(contractName, address, ABI, code, 0, feeLimit,
            consumeUserResourcePercent, libraryAddressPair, dbManager, null);
    byte[] contractAddress = result.getContractAddress();
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectEnergyUsageTotal + expectEnergyUsageTotal2) * 100);
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testFallback()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
  ...
  public void revertTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("testRevert()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
