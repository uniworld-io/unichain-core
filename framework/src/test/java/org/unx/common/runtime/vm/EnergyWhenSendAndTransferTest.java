...
public class EnergyWhenSendAndTransferTest {
  ...
  public void callValueTest()
    ...
    long feeLimit = 1000_000_000L; // ginza
    long consumeUserResourcePercent = 100;
    byte[] address = Hex.decode(OWNER_ADDRESS);
    UVMTestResult result = deployCallValueTestContract(value, feeLimit, consumeUserResourcePercent);
    ...
    /* =================================== CALL simpleCall() =================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("simpleCall()", null);
    result = UvmTestUtils
    ...
    /* =================================== CALL complexCall() =================================== */
    triggerData = UvmTestUtils.parseAbi("complexCall()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void sendTest()
    ...
    long value = 1000L;
    long feeLimit = 100_000_000L; // ginza
    long consumeUserResourcePercent = 100;
    byte[] address = Hex.decode(OWNER_ADDRESS);
    UVMTestResult result = deploySendAndTransferTestContract(value, feeLimit,
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("doSend()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void transferTest()
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = UvmTestUtils.parseAbi("doTransfer()", null);
    result = UvmTestUtils
        .triggerContractAndReturnUvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public UVMTestResult deployCallValueTestContract(long value, long feeLimit,
  ...
  public UVMTestResult deploySendAndTransferTestContract(long value, long feeLimit,
                                                         long consumeUserResourcePercent)
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException,
      VMIllegalException {
