...
import org.unx.core.vm.JumpTable;
import org.unx.core.vm.Op;
import org.unx.core.vm.Operation;
...
import org.unx.core.vm.program.invoke.ProgramInvokeMockImpl;
...
public class OperationsTest {
  ...
  private final JumpTable jumpTable = OperationRegistry.newUnxV10OperationSet();
  ...
  public static void init() {
    ...
    VMConfig.initAllowUvmCompatibleEvm(1);
  }

  @AfterClass
  public static void destroy() {
    Args.clearParam();
    VMConfig.initAllowUvmTransferUrc10(0);
    VMConfig.initAllowUvmConstantinople(0);
    VMConfig.initAllowUvmSolidity059(0);
    VMConfig.initAllowUvmIstanbul(0);
    VMConfig.initAllowUvmLondon(0);
    VMConfig.initAllowUvmCompatibleEvm(0);
  }
  ...
  private Program buildEmptyContext(byte[] ops) {
    Program context = new Program(
        ...
        new InternalTransaction(
            ...
            InternalTransaction.UnxType.UNX_UNKNOWN_TYPE));
  ...
  public void testArithmeticOperations() throws ContractValidateException {
    ...
    Protocol.Transaction unx = Protocol.Transaction.getDefaultInstance();
    InternalTransaction interUnx =
        new InternalTransaction(unx, InternalTransaction.UnxType.UNX_UNKNOWN_TYPE);

    // test ADD
    byte[] op = {0x60, 0x01, 0x60, 0x01, 0x01};
    program = new Program(op, op, invoke, interUnx);
  ...
  public void testPushDupSwapAndLogOperations() throws ContractValidateException {
    ...
    // test push(1-32)
    // byte[] op = {0x60, 0x01};
    // program = new Program(op, invoke, interUnx);
    // testOperations(program);
