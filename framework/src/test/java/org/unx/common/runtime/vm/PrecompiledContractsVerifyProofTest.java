...
import org.unx.core.vm.PrecompiledContracts.MerkleHash;
...
import org.unx.core.zen.ShieldedURC20ParametersBuilder.ShieldedURC20ParametersType;
...
public class PrecompiledContractsVerifyProofTest {
  ...
  public void verifyMintProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      builder.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
      builder.setShieldedURC20ParametersType(ShieldedURC20ParametersType.MINT);
      ...
      ShieldedURC20Parameters params = builder.build(false);
  ...
  public void verifyTransferProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint1
        ShieldedURC20ParametersBuilder mintBuilder1 = new ShieldedURC20ParametersBuilder();
        mintBuilder1.setTransparentFromAmount(BigInteger.valueOf(30));
        mintBuilder1.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder1.setShieldedURC20ParametersType(ShieldedURC20ParametersType.MINT);
        mintBuilder1.addOutput(DEFAULT_OVK, senderPaymentAddress1.getD(),
            senderPaymentAddress1.getPkD(), 30, rcm1, new byte[512]);
        ShieldedURC20Parameters mintParams1 = mintBuilder1.build(false);
      ...
      { //for mint2
        ShieldedURC20ParametersBuilder mintBuilder2 = new ShieldedURC20ParametersBuilder();
        mintBuilder2.setTransparentFromAmount(BigInteger.valueOf(70));
        mintBuilder2.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder2.setShieldedURC20ParametersType(ShieldedURC20ParametersType.MINT);
        mintBuilder2.addOutput(DEFAULT_OVK, senderPaymentAddress2.getD(),
            senderPaymentAddress2.getPkD(), 70, rcm2, new byte[512]);
        ShieldedURC20Parameters mintParams2 = mintBuilder2.build(false);
      ...
      { //for transfer
        ShieldedURC20ParametersBuilder builder = new ShieldedURC20ParametersBuilder();
        builder.setShieldedURC20ParametersType(ShieldedURC20ParametersType.TRANSFER);
        builder.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
        ...
        ShieldedURC20Parameters params = builder.build(true);
  ...
  public void verifyBurnWithCmCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for burn
        ShieldedURC20ParametersBuilder builder = new ShieldedURC20ParametersBuilder();
        builder.setShieldedURC20ParametersType(ShieldedURC20ParametersType.BURN);
        builder.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
        builder.setTransparentFromAmount(BigInteger.ZERO);
  ...
  public void verifyBurnProofCorrect() throws ZksnarkException {
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint
        ShieldedURC20ParametersBuilder mintBuilder = new ShieldedURC20ParametersBuilder();
        mintBuilder.setTransparentFromAmount(BigInteger.valueOf(value));
        mintBuilder.setShieldedURC20Address(SHIELDED_CONTRACT_ADDRESS);
        mintBuilder.setShieldedURC20ParametersType(ShieldedURC20ParametersType.MINT);
        mintBuilder.addOutput(DEFAULT_OVK, senderPaymentAddress.getD(),
            senderPaymentAddress.getPkD(), value, rcm, new byte[512]);
        ShieldedURC20Parameters mintParams = mintBuilder.build(false);
  ...
  private byte[] abiEncodeForMintWrongCM(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongCV(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongEpk(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongProof(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongBindingSignature(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForMintWrongHash(ShieldedURC20Parameters params, long value,
      byte[] frontier, long leafCount) {
    byte[] mergedBytes;
    ShieldContract.ReceiveDescription revDesc = params.getReceiveDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForTransferWrongNf(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongRoot(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongSpendCV(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongRk(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongSpendProof(ShieldedURC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongCM(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongReceiveCV(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongEpk(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongReceivProof(ShieldedURC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongBindingSignature(ShieldedURC20Parameters params,
      byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
  ...
  private byte[] abiEncodeForTransferWrongHash(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
    byte[] input = new byte[0];
    byte[] spendAuthSig = new byte[0];
    byte[] output = new byte[0];
  ...
  private byte[] abiEncodeForBurnWrongNF(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        Wallet.generateRandomBytes(32),
  ...
  private byte[] abiEncodeForBurnWrongRoot(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongCV(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongRK(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongProof(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongAuthoritySignature(ShieldedURC20Parameters params,
      long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
  ...
  private byte[] abiEncodeForBurnWrongBingSignature(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
  ...
  private byte[] abiEncodeForBurnWrongHash(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
    ShieldContract.SpendDescription spendDesc = params.getSpendDescription(0);
    mergedBytes = ByteUtil.merge(
        spendDesc.getNullifier().toByteArray(),
