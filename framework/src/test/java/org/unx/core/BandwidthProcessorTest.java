...
public class BandwidthProcessorTest {
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule unx = new TransactionCapsule(transferAssetContract);
    ...
    org.unx.protos.Protocol.Transaction.Contract contract =
        org.unx.protos.Protocol.Transaction.Contract
            .newBuilder()
    ...
    long bytes = unx.getSerializedSize();
    TransactionTrace trace = new TransactionTrace(unx, StoreFactory
  ...
  public void testFree() throws Exception {
    ...
    TransactionCapsule unx = new TransactionCapsule(contract);
    ...
    TransactionTrace trace = new TransactionTrace(unx, StoreFactory
        .getInstance(), new RuntimeImpl());
    dbManager.consumeBandwidth(unx, trace);
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = unx.getInstance().toBuilder().clearRet().build().getSerializedSize()
        + Constant.MAX_RESULT_SIZE_IN_TX;
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule unx = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(unx, StoreFactory
        .getInstance(), new RuntimeImpl());
