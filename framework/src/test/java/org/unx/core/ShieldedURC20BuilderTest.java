...
import org.unx.common.zksnark.LibrustzcashParam;
...
import org.unx.core.vm.PrecompiledContracts.VerifyBurnProof;
import org.unx.core.vm.PrecompiledContracts.VerifyMintProof;
import org.unx.core.vm.PrecompiledContracts.VerifyTransferProof;
import org.unx.core.zen.address.DiversifierT;
import org.unx.core.zen.address.ExpandedSpendingKey;
import org.unx.core.zen.address.FullViewingKey;
...
import org.unx.protos.contract.ShieldContract.SpendDescription;
import org.unx.core.zksnark.LibrustzcashTest;
import stest.unx.wallet.common.client.WalletClient;

@Slf4j
public class ShieldedURC20BuilderTest extends BlockGenerate {

  private static String dbPath = "output_Shielded_URC20_Api_test";
  ...
  public static void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveAllowShieldedURC20Transaction(1);
  ...
  public void createShieldedContractParametersForMint()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      GrpcAPI.PrivateShieldedURC20Parameters mintPrivateParam1 = mintParams(
          privateKey, value, SHIELDED_CONTRACT_ADDRESS_STR, null);
      GrpcAPI.ShieldedURC20Parameters urc20MintParams = wallet
          .createShieldedContractParameters(mintPrivateParam1);

      byte[] inputData = abiEncodeForMint(urc20MintParams, value, frontier, leafCount);
  ...
  * */
  ...
  public void createShieldedContractParametersForTransfer1to1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint1
        ...
        GrpcAPI.PrivateShieldedURC20Parameters.Builder paramBuilder = GrpcAPI
            .PrivateShieldedURC20Parameters.newBuilder();
        ...
        paramBuilder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
        PrivateShieldedURC20Parameters privMintParams = paramBuilder.build();

        ShieldedURC20Parameters minParam = wallet.createShieldedContractParameters(privMintParams);
      ...
      { //for transfer
        GrpcAPI.PrivateShieldedURC20Parameters.Builder privateURC20Builder = GrpcAPI
            .PrivateShieldedURC20Parameters.newBuilder();
        GrpcAPI.SpendNoteURC20.Builder spendNoteBuilder = GrpcAPI.SpendNoteURC20.newBuilder();
        GrpcAPI.Note note = getNote(100, senderPaymentAddressStr, rcm1, new byte[512]);
        ...
        privateURC20Builder.addShieldedSpends(spendNoteBuilder.build());
        ...
        privateURC20Builder.addShieldedReceives(revNoteBuilder.build());

        ExpandedSpendingKey expsk = senderSk.expandedSpendingKey();
        privateURC20Builder.setAsk(ByteString.copyFrom(expsk.getAsk()));
        privateURC20Builder.setNsk(ByteString.copyFrom(expsk.getNsk()));
        privateURC20Builder.setOvk(ByteString.copyFrom(expsk.getOvk()));
        privateURC20Builder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
        GrpcAPI.ShieldedURC20Parameters transferParam = wallet
            .createShieldedContractParameters(privateURC20Builder.build());
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for mint1
        ...
        paramBuilder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
        PrivateShieldedURC20Parameters privMintParams = paramBuilder.build();
        ShieldedURC20Parameters mintParam = wallet.createShieldedContractParameters(privMintParams);
      ...
      { //for transfer
        ...
        privateURC20Builder.addShieldedReceives(revNoteBuilder1.build());
        ...
        privateURC20Builder.addShieldedReceives(revNoteBuilder2.build());
  ...
  public void createShieldedContractParametersForTransfer2to1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for transfer
        GrpcAPI.PrivateShieldedURC20Parameters.Builder privateURC20Builder = GrpcAPI
            .PrivateShieldedURC20Parameters.newBuilder();
        GrpcAPI.SpendNoteURC20.Builder spendNoteBuilder1 = GrpcAPI.SpendNoteURC20.newBuilder();
        ...
        privateURC20Builder.addShieldedSpends(spendNoteBuilder1.build());

        //spendNote2
        GrpcAPI.SpendNoteURC20.Builder spendNoteBuilder2 = GrpcAPI.SpendNoteURC20.newBuilder();
        ...
        privateURC20Builder.addShieldedSpends(spendNoteBuilder2.build());
  ...
  public void createShieldedContractParametersForBurn1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for burn
        ...
        privateURC20Builder.setAsk(ByteString.copyFrom(expsk.getAsk()));
        privateURC20Builder.setNsk(ByteString.copyFrom(expsk.getNsk()));
        privateURC20Builder.setToAmount(BigInteger.valueOf(value).toString());
        privateURC20Builder.setTransparentToAddress(ByteString.copyFrom(PUBLIC_TO_ADDRESS));
        privateURC20Builder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
        GrpcAPI.ShieldedURC20Parameters burnParam = wallet
            .createShieldedContractParameters(privateURC20Builder.build());
  ...
  public void createShieldedContractParametersForBurn1to1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for burn
        ...
        privateURC20Builder.setAsk(ByteString.copyFrom(expsk.getAsk()));
        privateURC20Builder.setNsk(ByteString.copyFrom(expsk.getNsk()));
        privateURC20Builder.setToAmount(BigInteger.valueOf(60).toString());
        privateURC20Builder.setTransparentToAddress(ByteString.copyFrom(PUBLIC_TO_ADDRESS));
        privateURC20Builder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
  ...
  public void createShieldedContractParametersWithoutAskForTransfer1to1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for transfer
        GrpcAPI.PrivateShieldedURC20ParametersWithoutAsk.Builder privateURC20Builder = GrpcAPI
        ...
        ExpandedSpendingKey expsk = senderSk.expandedSpendingKey();
        privateURC20Builder.setAk(ByteString.copyFrom(senderFvk.getAk()));
        privateURC20Builder.setNsk(ByteString.copyFrom(expsk.getNsk()));
        privateURC20Builder.setOvk(ByteString.copyFrom(expsk.getOvk()));
        privateURC20Builder
            .setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
        GrpcAPI.ShieldedURC20Parameters transferParam = wallet
            .createShieldedContractParametersWithoutAsk(privateURC20Builder.build());

        //get the binding signature
        PrivateShieldedURC20ParametersWithoutAsk shieldedURC20ParametersWithoutAsk =
            privateURC20Builder
                .build();
        SpendAuthSigParameters.Builder signParamerters1 = SpendAuthSigParameters.newBuilder();
        signParamerters1
            .setAlpha(shieldedURC20ParametersWithoutAsk.getShieldedSpends(0).getAlpha());
        ...
        ShieldedURC20TriggerContractParameters.Builder triggerParam =
            ShieldedURC20TriggerContractParameters
                .newBuilder();
        triggerParam.setShieldedURC20Parameters(transferParam);
        triggerParam.addSpendAuthoritySignature(signMsg1);
        BytesMessage triggerInput = wallet
            .getTriggerInputForShieldedURC20Contract(triggerParam.build());
        logger.info(
        ...
        ShieldedURC20Parameters.Builder bindingSigBuilder = ShieldedURC20Parameters.newBuilder();
  ...
  public void createShieldedContractParametersWithoutAskForTransfer2to1()
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for transfer
        ...
        signParamerters2
            .setAlpha(shieldedURC20ParametersWithoutAsk.getShieldedSpends(1).getAlpha());
    ...
    for (int countNum = 0; countNum < totalCountNum; countNum++) {
      ...
      { //for burn
        ...
        ShieldedURC20TriggerContractParameters.Builder triggerParam =
            ShieldedURC20TriggerContractParameters
                .newBuilder();
        triggerParam.setShieldedURC20Parameters(burnParam);
        triggerParam.addSpendAuthoritySignature(signMsg1);
  ...
  public void getTriggerInputForForMint() throws Exception {
    ...
    GrpcAPI.PrivateShieldedURC20ParametersWithoutAsk.Builder paramBuilder = GrpcAPI
        .PrivateShieldedURC20ParametersWithoutAsk.newBuilder();
    paramBuilder.setOvk(ByteString.copyFrom(ovk));
    paramBuilder.setFromAmount(BigInteger.valueOf(revValue).toString());
    paramBuilder.addShieldedReceives(revNoteBuilder.build());
    paramBuilder.setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
    GrpcAPI.ShieldedURC20Parameters urc20MintParams = wallet
        .createShieldedContractParametersWithoutAsk(paramBuilder.build());

    GrpcAPI.PrivateShieldedURC20ParametersWithoutAsk privateParams = paramBuilder.build();

    //verify receiveProof && bindingSignature
    boolean result;
    long ctx = JLibrustzcash.librustzcashSaplingVerificationCtxInit();
    ShieldContract.ReceiveDescription revDesc = urc20MintParams.getReceiveDescription(0);
    try {
      ...
      result &= JLibrustzcash.librustzcashSaplingFinalCheck(
          new LibrustzcashParam.FinalCheckParams(
              ctx,
              valueBalance,
              urc20MintParams.getBindingSignature().toByteArray(),
              urc20MintParams.getMessageHash().toByteArray()));
    } catch (Throwable any) {
      result = false;
    } finally {
    ...
    ShieldedURC20TriggerContractParameters.Builder triggerParam =
        ShieldedURC20TriggerContractParameters
            .newBuilder();
    triggerParam.setShieldedURC20Parameters(urc20MintParams);
    triggerParam.setAmount(BigInteger.valueOf(revValue).toString());
    BytesMessage triggerInput = wallet
        .getTriggerInputForShieldedURC20Contract(triggerParam.build());
    Assert.assertArrayEquals(triggerInput.getValue().toByteArray(),
        Hex.decode(urc20MintParams.getTriggerContractInput()));
  }

  @Test
  public void testScanShieldedURC20NotesByIvk() throws Exception {
    int statNum = 1;
    int endNum = 100;
    LibrustzcashTest.librustzcashInitZksnarkParams();
    ...
    GrpcAPI.DecryptNotesURC20 scannedNotes = wallet.scanShieldedURC20NotesByIvk(
        statNum, endNum, SHIELDED_CONTRACT_ADDRESS, ivk, fvk.getAk(), fvk.getNk(), null);

    for (GrpcAPI.DecryptNotesURC20.NoteTx noteTx : scannedNotes.getNoteTxsList()) {
      logger.info(noteTx.toString());
    }
  }

  @Test
  public void testscanShieldedURC20NotesByOvk() throws Exception {
    int statNum = 9200;
    int endNum = 9240;
    SpendingKey sk = SpendingKey.decode(privateKey);
    FullViewingKey fvk = sk.fullViewingKey();

    GrpcAPI.DecryptNotesURC20 scannedNotes = wallet.scanShieldedURC20NotesByOvk(
  ...
  public void isShieldedURC20ContractNoteSpent() throws Exception {
    int statNum = 9200;
    int endNum = 9240;
    LibrustzcashTest.librustzcashInitZksnarkParams();
    SpendingKey sk = SpendingKey.decode(privateKey);
    ...
    GrpcAPI.NfURC20Parameters.Builder NfBuilfer;
    NfBuilfer = GrpcAPI.NfURC20Parameters.newBuilder();
    NfBuilfer.setAk(ByteString.copyFrom(fvk.getAk()));
    NfBuilfer.setNk(ByteString.copyFrom(fvk.getNk()));
    NfBuilfer.setPosition(271);
    NfBuilfer.setShieldedURC20ContractAddress(ByteString.copyFrom(SHIELDED_CONTRACT_ADDRESS));
    ...
    GrpcAPI.NullifierResult result = wallet
        .isShieldedURC20ContractNoteSpent(NfBuilfer.build());
    Assert.assertTrue(result.getIsSpent());
  }


  private byte[] abiEncodeForBurn(ShieldedURC20Parameters params, long value) {
    byte[] mergedBytes;
  ...
  private GrpcAPI.PrivateShieldedURC20Parameters mintParams(String privKey,
    ...
    paramBuilder.addShieldedReceives(revNoteBuilder.build());
    paramBuilder.setShieldedURC20ContractAddress(ByteString.copyFrom(contractAddress));
    return paramBuilder.build();
  }

  private byte[] abiEncodeForMint(ShieldedURC20Parameters params, long value,
  ...
  private byte[] abiEncodeForTransfer(ShieldedURC20Parameters params, byte[] frontier,
      long leafCount) {
