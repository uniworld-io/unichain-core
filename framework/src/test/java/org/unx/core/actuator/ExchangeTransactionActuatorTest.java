...
public class ExchangeTransactionActuatorTest {
    ...
    ExchangeCapsule exchangeCapsule =
        new ExchangeCapsule(
            ...
            1000000,
                UNW_SYMBOL_BYTES,
            "abc".getBytes());
    exchangeCapsule.setBalance(1_000_000_000_000L, 10_000_000L); // 1M UNW == 10M abc
    ...
    ExchangeCapsule exchangeCapsule3 =
        new ExchangeCapsule(
            ...
            1000000,
                UNW_SYMBOL_BYTES,
            "1".getBytes());
    exchangeCapsule3.setBalance(1_000_000_000_000L, 10_000_000L); // 1M UNW == 10M abc
  ...
  public void SameTokenNameCloseSuccessExchangeTransaction() {
    ...
    long exchangeId = 1;
    String tokenId = "_";
    long quant = 100_000_000L; // use 100 UNW to buy abc
