...
public class MarketSellAssetActuatorTest {
  ...
  private static final String UNW = "_";
  ...
  /**
   * no Enough Balance For Selling UNW, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingUNW() {
  ...
  /**
   * no buy orders before,add first sell order,selling UNW and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying UNW
   */
  @Test
