...
import static org.unx.common.utils.Commons.adjustAssetBalanceV2;
import static org.unx.common.utils.Commons.adjustBalance;
import static org.unx.common.utils.Commons.adjustTotalShieldedPoolValue;
...
import org.unx.protos.contract.AccountContract;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void updateRecentTransaction() throws Exception {
    ...
    Assert.assertEquals(unx.getTransactionId().toString(), item.getTransactionIds().get(0));
  }
  ...
  public void setBlockReference()
    ...
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(unx);
      Assert.assertEquals(1,
          ByteArray.toInt(unx.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction unx = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(unx);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract unx1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract unx2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(unx1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(unx2, ContractType.ShieldedTransferContract);
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.unx.net/first");
    ...
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.unx.net/three");
