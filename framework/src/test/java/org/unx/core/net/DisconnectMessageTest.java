...
import org.unx.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends com.google.protobuf.GeneratedMessageV3 implements
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.unx.protos.Protocol.ReasonCode getReason() {
    org.unx.protos.Protocol.ReasonCode result = org.unx.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.unx.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.unx.protos.Protocol.ReasonCode getName() {
    org.unx.protos.Protocol.ReasonCode result = org.unx.protos.Protocol.ReasonCode.valueOf(name_);
    return result == null ? org.unx.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (reason_ != org.unx.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.unx.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
