...
import static org.unx.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.unx.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.unx.common.zksnark.LibrustzcashParam.FinalCheckParams;
...
import org.unx.common.zksnark.MerklePath;
import org.unx.common.zksnark.ZksnarkClient;
...
import org.unx.core.zen.note.NoteEncryption.Encryption;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setUnxNum(UNX_NUM).setNum(NUM)
