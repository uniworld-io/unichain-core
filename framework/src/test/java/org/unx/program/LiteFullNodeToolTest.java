...
import org.unx.api.DatabaseGrpc;
...
public class LiteFullNodeToolTest {
  ...
  private void generateSomeTransactions(int during) {
    ...
    while (true) {
      ...
      String ginzaPri = "cba92a516ea09f620a16ff7ee95ce0df1d56550a8babe9964981a7144c8a784a";
      byte[] ginzaAddress = getFinalAddress(ginzaPri);
      sendcoin(address, 1L,
              ginzaAddress, ginzaPri, blockingStubFull);
      try {
