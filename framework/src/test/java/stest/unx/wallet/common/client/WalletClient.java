...
import org.unx.protos.Protocol.Witness;
...
import org.unx.protos.contract.WitnessContract;
...
public class WalletClient {
  ...
  public static boolean init(int itype) {
    ...
    if (config.hasPath("net.type") && "mainnet".equalsIgnoreCase(config.getString("net.type"))) {
      ...
      WalletClient.setAddressPreFixByte(Parameter.CommonConstant.ADD_PRE_FIX_BYTE_TESTNET);
    }
  ...
  public static GrpcClient init() {
    //Config config = org.unx.core.config.Configuration.getByPath("config.conf");
    Config config = Configuration.getByPath("testng.conf");
    dbPath = config.getString("CityDb.DbPath");
    txtPath = System.getProperty("user.dir") + "/" + config.getString("CityDb.TxtPath");
