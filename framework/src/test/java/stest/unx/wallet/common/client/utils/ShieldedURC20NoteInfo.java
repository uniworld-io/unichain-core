...
@AllArgsConstructor
public class ShieldedURC20NoteInfo {
  ...
  public ShieldedURC20NoteInfo() {
  }

  /**
   * format shieldedURC20 note to a string
   */
  ...
  /**
   * parse string to get shieldedURC20 note
   */
