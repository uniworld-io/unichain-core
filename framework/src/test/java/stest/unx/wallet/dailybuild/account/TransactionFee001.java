...
import stest.unx.wallet.common.client.utils.Retry;
...
public class TransactionFee001 {
  ...
  Long beforeBurnUnwAmount = 0L;
  Long afterBurnUnwAmount = 0L;
  String txid = null;
  ...
  public void test01DeployContractEnergyFeeToSr() {
    ...
    beforeBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertEquals(beforeBurnUnwAmount,afterBurnUnwAmount);
  }
  ...
  public void test02UpdateAccountPermissionAndMultiSiginTrans() {
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnUnwAmount - beforeBurnUnwAmount == 100000000L);
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnUnwAmount - beforeBurnUnwAmount == 1000000L);
  }
  ...
  public void test03OutOfTimeEnergyFeeToBlackHole() {
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnUnwAmount - beforeBurnUnwAmount == maxFeeLimit);
  }
  ...
  public void test04AccountCreate() {
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnUnwAmount - beforeBurnUnwAmount == 100000L);
  }
  ...
  @Test(enabled = true, description = "Test create urc10 token with fee not to sr")
  public void test06CreateAssetIssue() {
    ...
    afterBurnUnwAmount = blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()).getNum();
    Assert.assertTrue(afterBurnUnwAmount - beforeBurnUnwAmount == 1024000000L);
  ...
  @Test(enabled = true, description = "Test getburnunw api from solidity or pbft")
  public void test07GetBurnUnwFromSolidityOrPbft() {
    PublicMethed.waitSolidityNodeSynFullNodeData(blockingStubFull,blockingStubSolidity);
    Assert.assertEquals(blockingStubFull
        .getBurnUnw(EmptyMessage.newBuilder().build()),blockingStubSolidity.getBurnUnw(
        EmptyMessage.newBuilder().build()));
    Assert.assertEquals(blockingStubFull.getBurnUnw(EmptyMessage.newBuilder().build()),
        blockingStubPbft.getBurnUnw(
            EmptyMessage.newBuilder().build()));
  }
  /**
   * constructor.
