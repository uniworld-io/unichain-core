...
public class WalletTestAssetIssue007 {
  ...
  private static final Integer unxNum = 1;
  ...
  public void testParticipateAssetIssueUseParticipateBandwidth() {
    ...
    Assert.assertTrue(PublicMethed
        .createAssetIssue(asset007Address, name, totalSupply, unxNum, icoNum, start, end, 1,
    ...
    Assert.assertTrue(beforeBalance - unxNum * 1 * icoNum >= afterBalance);
  }
