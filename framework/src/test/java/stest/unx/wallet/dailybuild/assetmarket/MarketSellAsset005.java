package stest.unx.wallet.dailybuild.assetmarket;
...
public class MarketSellAsset005 {
  ...
  byte [] unx = ByteArray.fromString("_");
  ...
  @Test(enabled = true,description = "Create an order to sell Unw and buy Urc10")
  void test01SellUnwBuyUrc10() {
    ...
    String txid = PublicMethed.marketSellAsset(testAddress002,testKey002,unx,
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, assetAccountId001,
            sellTokenQuantity * 2,
            unx, buyTokenQuantity * 2, blockingStubFull);
  ...
  @Test(enabled = true,description = "Create an order to sell Urc10 and buy Unw")
  void test02SellUrc10BuyUnw() {
    long balanceAfter = PublicMethed.queryAccount(testKey001, blockingStubFull).getBalance();
    ...
    txid = PublicMethed.marketSellAsset(testAddress001, testKey001, unx,
            sellTokenQuantity * 2,
