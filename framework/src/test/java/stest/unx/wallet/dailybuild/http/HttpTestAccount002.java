...
public class HttpTestAccount002 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "FreezeBlance for unx power by http")
  public void test015FreezeUnxPower() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "UnFreezeBalance for unx power by http")
  public void test016UnFreezeBalanceForUnxPower() {
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
