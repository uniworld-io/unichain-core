...
public class HttpTestMarket001 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketSellAsset unx with urc10 by http")
   ...
   * constructor.
   */
  @Test(enabled = true, description = "MarketCancelOrder unx with urc10 by http")
