...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "URC20 transfer token")
  public void urc20() {
    ...
    //Deploy contract1, contract1 has a function to transaction 5 ginza to target account
    String contractName = "UNX URC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_URC20_UNX");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_URC20_UNX");
