...
public class MultiSign06 {
  ...
  @Test(enabled = true, description = "Owner type in exception condition")
  ...
  @Test(enabled = true, description = "Owner type is 0")
  ...
  @Test(enabled = true, description = "Owner type is 0.1")
