...
@Slf4j
public class ContractUrcToken005 {
  ...
  public void deployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractUrcToken005.sol";
    ...
    Assert.assertEquals(
        "contract validate error : invalid arguments with tokenValue = 10, tokenId = 0"
            .toLowerCase(), response.getMessage().toStringUtf8().toLowerCase());
