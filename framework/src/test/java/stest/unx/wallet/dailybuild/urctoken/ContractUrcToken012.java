...
@Slf4j
public class ContractUrcToken012 {
  ...
  @Test(enabled = true, description = "deploy transfer contract with correct value")
  public void test01DeployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractUrcToken012.sol";
  ...
  public void test02TriggerContract() {
    ...
    Long receiveAssetBefore = PublicMethed.getAssetIssueValue(dev001Address, assetAccountId,
        blockingStubFull);
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "transferTokenTest(address,uint256,urcToken)", param, false, callValue,
    ...
    Long receiveAssetAfter = PublicMethed.getAssetIssueValue(dev001Address,
        assetAccountId, blockingStubFull);
  ...
  public void test03TriggerTokenBalanceContract() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "getTokenBalnce(address,urcToken)",
    ...
    Long assetAccountCount = ByteArray
            .toLong(infoById.get().getContractResult(0).toByteArray());
    logger.info("the receivercontract token from contract: " + assetAccountCount);
