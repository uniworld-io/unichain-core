...
@Slf4j
public class ContractUrcToken023 {
  ...
  @Test(enabled = true, description = "deploy contract for transfer token")
  public void deploy01TransferTokenContract() {

    Assert.assertTrue(PublicMethed
            .sendcoin(dev001Address, 4048000000L, fromAddress, testKey002, blockingStubFull));
    ...
    String filePath2 = "src/test/resources/soliditycode/contractUrcToken023.sol";
    ...
    PublicMethed.transferAsset(transferTokenContractAddress, assetAccountId.toByteArray(),
            100, dev001Address, dev001Key, blockingStubFull);

    PublicMethed.waitProduceNextBlock(blockingStubFull);
  }

  @Test(enabled = true, description = "transfer token which from address does not have")
  public void deploy02TransferTokenContract() {
    ...
    Long beforeAssetIssueDevAddress = PublicMethed.getAssetIssueValue(dev001Address,
    ...
    Long beforeAssetIssueBAddress = PublicMethed.getAssetIssueValue(btestAddress,
            assetAccountId, blockingStubFull);
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "TransferTokenTo(address,urcToken,uint256)", param, false, 0,
