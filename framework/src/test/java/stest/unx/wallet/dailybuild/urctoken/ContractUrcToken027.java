...
@Slf4j
public class ContractUrcToken027 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String filePath = "src/test/resources/soliditycode/contractUrcToken027.sol";
  ...
  public void deploy02TransferTokenContract() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "testIndelegateCall(address,address,address,uint256,urcToken)",
