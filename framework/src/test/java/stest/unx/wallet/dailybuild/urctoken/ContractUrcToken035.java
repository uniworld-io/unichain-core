...
@Slf4j
public class ContractUrcToken035 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethed.sendcoin(dev001Address, 9999000000L, fromAddress,
    ...
    String filePath = "src/test/resources/soliditycode/contractUrcToken035.sol";
  ...
  public void deploy02TransferTokenContract() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "failTransferTokenError(address,uint256,urcToken)",
