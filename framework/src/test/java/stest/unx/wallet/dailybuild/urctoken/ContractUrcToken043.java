...
@Slf4j
public class ContractUrcToken043 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractUrcToken043.sol";
  ...
  public void test03TriggerContract() {
    ...
    // tokenId is 0, contract not have unx
    ...
    //tokenId is 0, transfer contract has unx, transfer to normal account
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
