...
public class Create2Test012 {
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode and salt 1")
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode and salt 2")
  public void test03TriggerCreate2ToDeployTestContract2() {
    ...
    // contract address are different with different salt
