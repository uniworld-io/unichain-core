...
public class Create2Test018 {
  ...
  @Test(enabled = false, description = "Deploy factory contract generated by new solidity")
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(PublicMethed.sendcoin(witnessAddress001, 100_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  @Test(enabled = false, description = "Trigger create2 function to deploy test contract "
      + "using Witness account")
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(fromAddress, 9000_000_000_000L, 0, 1,
        ByteString.copyFrom(witnessAddress001), testKey002, blockingStubFull));
    ...
    accountResource = PublicMethed.getAccountResource(witnessAddress001, blockingStubFull);
    long userEnergyLimitBefore = accountResource.getEnergyLimit();
    long userEnergyUsageBefore = accountResource.getEnergyUsed();
    long userBalanceBefore = PublicMethed.queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
    ...
    final String triggerTxid = PublicMethed.triggerContract(factoryContractAddress,
        ...
        1000000000L, "0", 0, witnessAddress001, witnessKey001,
        blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    long userBalanceAfter = PublicMethed.queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
  ...
  @Test(enabled = false, description = "Trigger Test contact")
  public void test03TriggerTestContract() {

    Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(fromAddress,
        PublicMethed.getFreezeBalanceCount(witnessAddress001, witnessKey001, 50000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(witnessAddress001), testKey002, blockingStubFull));
    ...
    PublicMethed.unFreezeBalance(fromAddress, testKey002, 0,
        dev001Address, blockingStubFull);
    PublicMethed.unFreezeBalance(fromAddress, testKey002, 1,
        witnessAddress001, blockingStubFull);
    PublicMethed.unFreezeBalance(fromAddress, testKey002, 0,
        witnessAddress001, blockingStubFull);
