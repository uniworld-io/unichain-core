...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    //Trigger contract to transfer unx and token.
  ...
  @Test(enabled = true, description = "Create2 contract can transfer unx and token.")
  public void test2TriggerContract() {
    ...
    String txid1 = PublicMethed
        .triggerContract(bytes,
            "testTransferToken(uint256,urcToken)", num, false,
            0, maxFeeLimit, "0", 0, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
