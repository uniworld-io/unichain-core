package stest.unx.wallet.dailybuild.uvmnewcommand.extCodeHash;
...
public class ExtCodeHashTest004 {
  ...
  public void test01DeployExtCodeHashContract() {
    ...
    testContractAddress = PublicMethed.create2(parameter);
  ...
  public void test02GetCreate2CodeHash() {
    ...
    String param =
        "\"" + Base58.encode58Check(WalletClient.decodeFromBase58Check(testContractAddress)) + "\"";
