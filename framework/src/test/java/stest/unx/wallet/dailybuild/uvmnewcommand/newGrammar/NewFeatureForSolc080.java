...
public class NewFeatureForSolc080 {
  ...
  @Test(enabled = true, description = "transfer unx to tx.origin address with payable")
  ...
  @Test(enabled = true, description = "transfer unx to literal address with payable")
