...
import static org.unx.protos.Protocol.Transaction.Result.contractResult.SUCCESS_VALUE;
...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    String filePath = "src/test/resources/soliditycode/contractUrcToken031.sol";
    ...
    Assert.assertEquals("Contract validate error : Cannot transfer UNW to a smartContract.",
