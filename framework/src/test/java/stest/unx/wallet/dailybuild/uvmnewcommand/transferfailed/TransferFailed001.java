package stest.unx.wallet.dailybuild.uvmnewcommand.transferfailed;

import static org.unx.protos.Protocol.TransactionInfo.code.FAILED;
...
public class TransferFailed001 {
  ...
  @Test(enabled = true, description = "Transfer unw insufficient balance")
  public void test001TransferUnwInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferUnwInsufficientBalance(uint256)", num, false,
  ...
  @Test(enabled = true, description = "Transfer unw nonexistent target")
  public void test003TransferUnwNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferUnwNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  @Test(enabled = true, description = "Transfer unw to myself")
  public void test004TransferUnwSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferUnwSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer unw failed: Cannot transfer UNW to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  @Test(enabled = true, description = "Transfer unw nonexistent target and insufficient balance")
  public void test005TransferUnwNonexistentTarget() {
  ...
  @Test(enabled = true, description = "Transfer unw to myself and insufficient balance")
  public void test006TransferUnwSelf() {
  ...
  public void test008TransferUrctoken() {
  ...
  public void test009TransferUrctoken() {
  ...
  @Test(enabled = true, description = "transferUnw to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferUnwrevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
