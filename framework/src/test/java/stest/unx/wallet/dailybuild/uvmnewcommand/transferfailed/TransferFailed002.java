...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnwInsufficientBalance(uint256)", num, false, 0,
  ...
  @Test(enabled = true, description = "Send unx nonexistent target")
  public void test3SendUnwNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnwNonexistentTarget(uint256,address)", num,
  ...
  @Test(enabled = true, description = "Send unx self")
  public void test4SendUnwSelf() {
    Account info;
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnwSelf(uint256)", num, false, 0, maxFeeLimit,
    ...
    Assert.assertEquals("transfer unx failed: Cannot transfer UNW to yourself.",
  ...
  @Test(enabled = true, description = "Send unx nonexistent target and balance not enough")
  public void test5SendUnwNonexistentTarget() {
    Account info;
  ...
  @Test(enabled = true, description = "Send unx self and balance not enough")
  public void test6SendUnwSelf() {
    Account info;
  ...
  @Test(enabled = true, description = "Send unx nonexistent target, but revert")
  public void test7SendUnwNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendUnwRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
