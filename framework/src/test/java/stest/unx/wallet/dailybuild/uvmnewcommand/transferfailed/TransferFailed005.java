...
public class TransferFailed005 {
  ...
  public void triggerContract01() {
    ...
    // transfer unw to self`s account
    String param = "\"" + paramValue + "\",\"" + Base58.encode58Check(contractAddress) + "\"";
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCallUnwInsufficientBalance(uint256,address)", param,
    ...
    // transfer unx to unactivate account
    ...
    // transfer unx to caller, value enough , function success contractResult(call_value) successed
    ...
    // transfer unx to caller, value not enough, function success
  ...
  public void triggerContract02() {
    ...
    String triggerTxid = PublicMethed
        .triggerContract(contractAddress, "testCreateUnxInsufficientBalance(uint256)", param, false,
  ...
  public void triggerContract04() {
    ...
    TransactionExtention return1 = PublicMethed.triggerConstantContractForExtention(contractAddress,
        "testTransferUnwInsufficientBalance(uint256)", "1", false, 0L, 1000000000, "0", 0L,
        accountExcAddress, accountExcKey, blockingStubFull);
    Assert.assertEquals(response_code.SUCCESS, return1.getResult().getCode());
    /*Assert.assertEquals(
        "class org.unx.core.vm.program.Program$StaticCallModificationException "
