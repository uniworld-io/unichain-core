...
public class TransferFailed008 {
  ...
  public void test1TransferToOldContractAddress() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "transferTokenTest(address,uint256,urcToken)", num, false,
  ...
  public void test1TransferToNewContract() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "createContractTest(uint256,urcToken)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  public void test2TransferToNonexistentTargetInConstructor() {
    ...
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    String constructorStr = "constructor(address,uint256,urcToken)";
    String argsStr =
    ...
    Assert.assertEquals(0L, nonexistentAddressAccountUnwBalance.getBalance());
  ...
  public void test4GetTokenBalanceInConstructor() {
    ...
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    String constructorStr = "constructor(urcToken)";
