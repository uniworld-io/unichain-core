package stest.unx.wallet.dailybuild.uvmnewcommand.uvmassetissue;
...
public class UvmAssetIssue002 {
  ...
  public void tokenIssue001IllegalParameterVerification() {
    ...
    String filePath = "./src/test/resources/soliditycode/uvmAssetIssue001.sol";
    String contractName = "uvmAssetIssue001";
    ...
    // assetName is unw
    String tokenName = PublicMethed.stringToHexString("unw");
    ...
    // totalSupply is -1
    tokenName = PublicMethed.stringToHexString(name);
    tokenAbbr = PublicMethed.stringToHexString("unw");
    param =
    ...
    Assert.assertEquals("unw", ByteArray.toStr(assetIssueById.getAbbr().toByteArray()));
    assetV2Map = PublicMethed.queryAccount(contractAddress, blockingStubFull)
        .getAssetV2Map();
  ...
  @Test(enabled = false, description = "tokenIssue unw balance insufficient")
  public void tokenIssue002UnwBalanceInsufficient() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/uvmAssetIssue001.sol";
  ...
  public void tokenIssue003CalledMultipleTimesInOneContract() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/uvmAssetIssue002.sol";
    String contractName = "uvmAssetIssue002";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void tokenIssue004Revert() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 3100_000_000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/uvmAssetIssue003.sol";
    String contractName = "uvmAssetIssue003";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void tokenIssue005CallAnotherInOneContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/uvmAssetIssue004.sol";
    String contractName = "uvmAssetIssue004";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    ...
    String methodTransferToken = "transferToken(address,uint256,urcToken)";
