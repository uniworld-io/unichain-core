...
public class StackSuicideTest001 {
  ...
  @Test(enabled = false, description = "targetAddress no UNW, and no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has UNW, but no frozen")
  ...
  @Test(enabled = false, description = "targetAddress has UNW, and has frozen")
