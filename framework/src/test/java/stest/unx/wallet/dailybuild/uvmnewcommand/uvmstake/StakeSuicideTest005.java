package stest.unx.wallet.dailybuild.uvmnewcommand.uvmstake;
...
public class StakeSuicideTest005 {
  ...
  @Test(enabled = false, description = "targetAddress is account no UNW, and no frozen")
  void uvmStakeSuicideTest001() {
  ...
  @Test(enabled = false, description = "targetAddress is account 1 UNW, and no frozen")
  void uvmStakeSuicideTest002() {
    ECKey ecKeyTargetAddress = new ECKey(Utils.getRandom());
    byte[] targetAddress = ecKeyTargetAddress.getAddress();
  ...
  @Test(enabled = false, description = "targetAddress is account 1 UNW, and 1 frozen")
  void uvmStakeSuicideTest003() {
    ECKey ecKeyTargetAddress = new ECKey(Utils.getRandom());
    byte[] targetAddress = ecKeyTargetAddress.getAddress();
    String testKeyTargetAddress = ByteArray.toHexString(ecKeyTargetAddress.getPrivKeyBytes());
    Assert.assertTrue(PublicMethed
