...
contract transferTokenContract {
    ...
    function msgTokenValueAndTokenIdTest() public payable returns(urcToken, uint256){
    ...
    function getTokenBalnce(address toAddress, urcToken tokenId) public payable returns(uint256){
