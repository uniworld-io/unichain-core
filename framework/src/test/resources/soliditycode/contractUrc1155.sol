...
library Address {
    ...
    function isAContract(address account) internal view returns (bool) {
    ...
    function functionCallWithValue(
        ...
        require(isAContract(target), "Address: call to non-contract");
    ...
    function functionStaticCall(
        ...
        require(isAContract(target), "Address: static call to non-contract");
    ...
    function functionDelegateCall(
        ...
        require(isAContract(target), "Address: delegate call to non-contract");
...
contract MyContractCanReceiver is ERC1155Holder {
}



contract MyContractCanNotReceiver  {
}