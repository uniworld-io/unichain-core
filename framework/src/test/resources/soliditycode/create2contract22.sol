contract Factory {
    event Deployed(address addr, urcToken salt, address sender);
    ...
    function deploy(bytes memory code, urcToken salt) public returns(address){
        address addr;
        assembly {
...
contract TestConstract {
    ...
    function testTransferToken(uint256 i,urcToken tokenId) payable public{
