...
contract uvmAssetIssue002 {
    ...
    function updateAsset(urcToken tokenId, string memory url1, string memory desc1, string memory url2, string memory desc2) public returns (bool) {
