...
contract transferTokenTestA {
    ...
    // transfer urc10 to a new address or exist address in constructor
    constructor(address payable toAddress, uint256 tokenValue, urcToken id) payable public{
    ...
    function transferTokenTest(address payable toAddress, uint256 tokenValue, urcToken id) payable public    {
        toAddress.transferToken(tokenValue, id);
    }
    ...
    function createContractTest(uint256 tokenValue, urcToken id) payable public returns(address){
        Simple s = new Simple();
    ...
    function revertCreateContractTest(uint256 tokenValue, urcToken id) payable public {
        Simple s = new Simple();
        address(s).transferToken(tokenValue, id);
        revert();
    }
...
contract transferTokenTestC {
    ...
    constructor(urcToken id) payable public{
        s = new Simple();
