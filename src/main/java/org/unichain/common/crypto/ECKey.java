...
import org.unichain.common.crypto.jce.ECKeyAgreement;
import org.unichain.common.crypto.jce.ECKeyFactory;
import org.unichain.common.crypto.jce.ECKeyPairGenerator;
import org.unichain.common.crypto.jce.ECSignatureFactory;
...
public class ECKey implements Serializable {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(UnichainCastleProvider.getInstance())
