...
import org.unichain.common.overlay.message.DisconnectMessage;
import org.unichain.common.overlay.message.HelloMessage;
import org.unichain.common.overlay.message.MessageCodec;
import org.unichain.common.overlay.message.StaticMessages;
import org.unichain.core.db.ByteArrayWrapper;
import org.unichain.core.exception.P2pException;
import org.unichain.core.net.UnichainNetHandler;
...
public class Channel {
  ...
  @Autowired
  private UnichainNetHandler unichainNetHandler;
  ...
  private UnichainState unichainState = UnichainState.INIT;
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    unichainNetHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    unichainNetHandler.setMsgQueue(msgQueue);
  }
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", unichainNetHandler);
    setStartTime(msg.getTimestamp());
    setUnichainState(UnichainState.HANDSHAKE_FINISHED);
  ...
  public void setUnichainState(UnichainState unichainState) {
    this.unichainState = unichainState;
    logger.info("Peer {} status change to {}.", inetSocketAddress, unichainState);
  }
