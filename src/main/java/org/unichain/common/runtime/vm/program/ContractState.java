...
import org.unichain.common.runtime.vm.program.listener.ProgramListener;
import org.unichain.common.runtime.vm.program.listener.ProgramListenerAware;
import org.unichain.common.storage.Deposit;
import org.unichain.common.storage.Key;
import org.unichain.common.storage.Value;
...
public class ContractState implements Deposit, ProgramListenerAware {
  ...
  public TransactionCapsule getTransaction(byte[] unxHash) {
    return this.deposit.getTransaction(unxHash);
  }
  ...
  public byte[] getBurnAccountAddress() {
    return deposit.getBurnAccountAddress();
  }
