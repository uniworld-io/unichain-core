...
import org.unichain.core.db.api.index.Index.Iface;
import org.unichain.core.db.common.WrappedByteArray;
import org.unichain.core.db.common.WrappedResultSet;
...
public abstract class AbstractIndex<E extends ProtoCapsule<T>, T> implements Iface<T> {
  ...
  protected IUnichainChainBase<E> database;
  ...
  public AbstractIndex(IUnichainChainBase<E> database) {
