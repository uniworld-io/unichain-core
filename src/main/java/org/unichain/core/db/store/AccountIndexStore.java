...
@Component
public class AccountIndexStore extends UnichainStoreWithRevoking<BytesCapsule> {
  ...
  public void put(AccountCapsule accountCapsule) {
    put(accountCapsule.getAccountName().toByteArray(), new BytesCapsule(accountCapsule.getAddress().toByteArray()));
  }
