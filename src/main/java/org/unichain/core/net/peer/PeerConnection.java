...
public class PeerConnection extends Channel {
  ...
  public void onConnect() {
    if (getHelloMessage().getHeadBlockId().getNum() > unichainNetDelegate.getHeadBlockId().getNum()) {
      setUnichainState(UnichainState.SYNCING);
      syncService.startSync(this);
    } else {
      setUnichainState(UnichainState.SYNC_COMPLETED);
    }
  }
