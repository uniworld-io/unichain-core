...
@Component
@Slf4j(topic = "API")
public class MineTokenServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      Transaction tx = wallet.createTransactionCapsule(build.build(), ContractType.MineTokenContract).getInstance();
