...
@Component
@Slf4j(topic = "API")
public class Urc40TotalSupplyServlet extends HttpServlet {
  @Autowired
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      var msg = wallet.urc40TotalSupply(builder.build());
      if (msg != null) {
      ...
      try {
        logger.error("Urc40TotalSupply error: {}", e.getMessage(), e);
