...
@Component
@Slf4j(topic = "API")
public class Urc721SetApprovalForAllServlet extends HttpServlet {
  @Autowired
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      var builder = Contract.Urc721SetApprovalForAllContract.newBuilder();
      JsonFormat.merge(contract, builder, visible);
      var tx = urc721.setApprovalForAll(builder.build());
