...
import org.unichain.core.services.http.fullnode.servlet.GetAccountByIdServlet;
...
@Component
@Slf4j(topic = "API")
public class GetTokenFutureOnSolidityServlet extends GetTokenFutureServlet {
