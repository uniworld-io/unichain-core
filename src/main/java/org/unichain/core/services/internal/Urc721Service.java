...
public interface Urc721Service {
    ...
    Protocol.Urc721TokenApproveQueryResult getListApproval(Protocol.Urc721TokenApproveQuery query);
    ...
    Protocol.Urc721TokenApproveAllResult getApprovalForAll(Protocol.Urc721TokenApproveAllQuery query);
