 ...
 *
 * <p><sunichaing>Note:</sunichaing> the Bouncy Castle Scrypt implementation {@link SCrypt}, fails to comply
...
public class Wallet {
  ...
  private static WalletFile createWalletFile(
    ...
    walletFile.setAddress(org.unichain.core.Wallet.encode58Check(ecKeyPair.getAddress()));
