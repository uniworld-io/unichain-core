...
public class TestPOSBridge {
    ...
    public  void testBase58Decode(){
        ...
        Assert.assertTrue( addr!= null, "invalid Genesis admin wallet");
    ...
    public void testValidatingSignatures(){
        try {
            ...
            Assert.assertTrue(PosBridgeUtil.validateSignatures(msgHex, sigList, configCap), "invalid signature");
    ...
    public void testDecodeWithdrawMsg(){
        try {
            ...
            Assert.assertTrue((decoded.childChainId == expectDecode.childChainId)
                    ...
                    "unmatched decode msg, expected : " +  expectDecode + "\n got: " + decoded);
            System.out.println("+++ testDecodeWithdrawMsg:  SUCCESS -->" + decoded);
        }
        catch (Exception e){
            System.err.println("+++ testDecodeWithdrawMsg:  FAILED -->" + e);
        }
    }
    ...
    public void testValidatorCodec(){
        try {
            ...
            Assert.assertTrue(rAddr1.toString().equalsIgnoreCase(addr1), "ummatched address1");
            Assert.assertTrue(rAddr2.toString().equalsIgnoreCase(addr2), "ummatched address2");
            System.out.println("+++ testValidatorCodec:  SUCCESS!");
        }
        catch (Exception e){
            System.err.println("+++ testValidatorCodec:  FAILED -->" + e);
        }
    }
    ...
    public void testRecoverAddressFromSignature(){
        try {
            ...
            Assert.assertTrue(addrRecover.equalsIgnoreCase(addr), "unmatched recover addr: " + addrRecover + " vs " + addr);
            System.out.println("+++ testRecoverAddressFromSignature:  SUCCESS!");
        } catch (Exception e) {
            System.err.println("+++ testRecoverAddressFromSignature:  FAILED -->" + e);
        }
    }
    ...
    public void testGenAddr(){
        try {
            ...
            System.out.println("+++ testGenAddr:  SUCCESS: addr:" + hexString +", priv: " + priKeyStr);
        }
        catch (Exception e){
            System.err.println("+++ testGenAddr:  FAILED -->" + e);
        }
    }
    ...
    public void testRlpDecode(){
        try {
            ...
            System.out.println("+++ testRlpDecode:  SUCCESS!");
        } catch (Exception e) {
            System.err.println("+++ testRlpDecode:  FAILED -->" + e);
        }
    }
}
